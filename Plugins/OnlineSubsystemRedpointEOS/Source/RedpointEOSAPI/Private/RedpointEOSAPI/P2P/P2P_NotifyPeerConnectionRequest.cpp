...
REDPOINT_EOSSDK_API_CALL_EVENT_IMPL(NotifyPeerConnectionRequest);

void FNotifyPeerConnectionRequest::MapOptions(
...
void FNotifyPeerConnectionRequest::MapResult(
    Result &Result,
