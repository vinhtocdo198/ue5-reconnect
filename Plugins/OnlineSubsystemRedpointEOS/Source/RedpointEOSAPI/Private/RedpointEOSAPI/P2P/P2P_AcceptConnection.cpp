...
REDPOINT_EOSSDK_API_CALL_SYNC_IMPL(AcceptConnection);

void FAcceptConnection::MapOptions(NativeOptions &NativeOptions, const Options &Options, NativeAllocator &Allocator)
{
