...
#include "RedpointEOSAPI/P2P/NotifyPeerConnectionEstablished.h"
...
REDPOINT_EOSSDK_API_CALL_EVENT_IMPL(NotifyPeerConnectionEstablished);

void FNotifyPeerConnectionEstablished::MapOptions(
...
void FNotifyPeerConnectionEstablished::MapResult(
    Result &Result,
    ...
    NativeConverter &Converter)
{
    ...
    Result.ConnectionType = NativeResult.ConnectionType;
    Result.NetworkType = NativeResult.NetworkType;
}
