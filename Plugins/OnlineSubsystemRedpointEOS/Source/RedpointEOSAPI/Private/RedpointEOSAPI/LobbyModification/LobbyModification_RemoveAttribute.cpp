...
REDPOINT_EOSSDK_API_CALL_OBJECT_SYNC_IMPL(RemoveAttribute);

void FRemoveAttribute::MapOptions(NativeOptions &NativeOptions, const Options &Options, NativeAllocator &Allocator)
{
