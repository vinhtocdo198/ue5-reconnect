...
REDPOINT_EOSSDK_API_CALL_ASYNC_IMPL(PromoteMember);

void FPromoteMember::MapOptions(NativeOptions &NativeOptions, const Options &Options, NativeAllocator &Allocator)
{
...
void FPromoteMember::MapResult(Result &Result, const NativeResult &NativeResult, NativeConverter &Converter)
{
