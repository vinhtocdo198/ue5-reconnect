...
REDPOINT_EOSSDK_API_CALL_ASYNC_IMPL(JoinLobby);

void FJoinLobby::MapOptions(NativeOptions &NativeOptions, const Options &Options, NativeAllocator &Allocator)
{
    NativeOptions.LocalUserId = *Options.LocalUserId;
    NativeOptions.LobbyDetailsHandle = (*Options.LobbyDetails)->Value();
...
void FJoinLobby::MapResult(Result &Result, const NativeResult &NativeResult, NativeConverter &Converter)
{
