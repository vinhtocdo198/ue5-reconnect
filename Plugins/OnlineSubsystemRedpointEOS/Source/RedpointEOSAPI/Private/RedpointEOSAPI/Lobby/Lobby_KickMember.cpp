...
REDPOINT_EOSSDK_API_CALL_ASYNC_IMPL(KickMember);

void FKickMember::MapOptions(NativeOptions &NativeOptions, const Options &Options, NativeAllocator &Allocator)
{
...
void FKickMember::MapResult(Result &Result, const NativeResult &NativeResult, NativeConverter &Converter)
{
