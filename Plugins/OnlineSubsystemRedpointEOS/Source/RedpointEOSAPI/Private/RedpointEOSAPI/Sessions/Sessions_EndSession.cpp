...
#include "RedpointEOSAPI/Sessions/EndSession.h"
...
REDPOINT_EOSSDK_API_CALL_ASYNC_IMPL(EndSession);
...
void FEndSession::MapResult(Result &Result, const NativeResult &NativeResult, NativeConverter &Converter)
{
