...
#define REDPOINT_EOSSDK_API_CALL_OBJECT_SYNC_LIST_COPY_IMPL(CallName)                                                  \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            ...
            EOS_EResult CopyResult =                                                                                   \
                NativeCopyByIndexFunction(InHandle->Value(), &_NativeCopyByIndexOptions, &_NativeResultEntry);         \
