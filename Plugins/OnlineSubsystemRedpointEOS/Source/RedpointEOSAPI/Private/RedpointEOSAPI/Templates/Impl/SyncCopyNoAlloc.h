...
#define REDPOINT_EOSSDK_API_CALL_SYNC_COPY_NOALLOC_IMPL(CallName)                                                      \
    ...
    {                                                                                                                  \
        ...
        UE_LOG(                                                                                                        \
            ...
            VeryVerbose,                                                                                               \
            TEXT("[complete] %s"),                                                                                     \
            *ConvertError(LogCallName(), TEXT("Sync copy no alloc call completed."), OutResultCode).ToLogString());    \
        return;                                                                                                        \
    }
