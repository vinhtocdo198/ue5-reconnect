...
class REDPOINTEOSAPI_API FNotifyPeerConnectionRequest
{
    REDPOINT_EOSSDK_API_CALL_EVENT_BEGIN(P2P, PeerConnectionRequest, EOS_P2P_ADDNOTIFYPEERCONNECTIONREQUEST_API_LATEST)
