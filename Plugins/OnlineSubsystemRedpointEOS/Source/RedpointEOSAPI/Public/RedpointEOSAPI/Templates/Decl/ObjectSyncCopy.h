...
#define REDPOINT_EOSSDK_API_CALL_OBJECT_SYNC_COPY_BEGIN(CallNamespace, CallName, CallVersion, ResultEntryName)         \
private:                                                                                                               \
...
#define REDPOINT_EOSSDK_API_CALL_OBJECT_SYNC_COPY_END()                                                                \
public:                                                                                                                \
    static void Execute(                                                                                               \
