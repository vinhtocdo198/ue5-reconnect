...
#define REDPOINT_EOSSDK_API_CALL_OBJECT_SYNC_BEGIN(CallNamespace, CallName, CallVersion)                               \
private:                                                                                                               \
...
#define REDPOINT_EOSSDK_API_CALL_OBJECT_SYNC_END()                                                                     \
public:                                                                                                                \
    static EOS_EResult Execute(TReleasableRef<NativeHandle> InHandle, const Options &InOptions);                       \
                                                                                                                       \
private:                                                                                                               \
