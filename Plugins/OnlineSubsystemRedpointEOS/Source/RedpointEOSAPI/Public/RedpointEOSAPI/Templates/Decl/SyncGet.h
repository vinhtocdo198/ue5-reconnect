...
#include "RedpointEOSAPI/Templates/NativeCall/SyncGetInfo.h"
...
#define REDPOINT_EOSSDK_API_CALL_SYNC_GET_BEGIN(CallNamespace, CallName, CallVersion)                                  \
private:                                                                                                               \
    REDPOINT_EOS_DECLARE_API_CALL_LLM_TAG(CallNamespace, CallName);                                                    \
    typedef EOS_H##CallNamespace NativeHandle;                                                                         \
    typedef ::Redpoint::EOS::API::Templates::NativeCall::TSyncGetInfo<                                                 \
...
#define REDPOINT_EOSSDK_API_CALL_SYNC_GET_END()                                                                        \
public:                                                                                                                \
    static EOS_EResult Execute(const FPlatformHandle &InHandle, const Options &InOptions, Result &OutResult);          \
    static EOS_EResult Execute(NativeHandle InHandle, const Options &InOptions, Result &OutResult);                    \
                                                                                                                       \
private:                                                                                                               \
