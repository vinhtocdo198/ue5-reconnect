...
#include "RedpointEOSAPI/Templates/NativeCall/AsyncWithImmediateErrorInfo.h"
...
#define REDPOINT_EOSSDK_API_CALL_ASYNC_WITH_IMMEDIATE_ERROR_BEGIN(CallNamespace, CallName, CallVersion)                \
private:                                                                                                               \
    REDPOINT_EOS_DECLARE_API_CALL_LLM_TAG(CallNamespace, CallName);                                                    \
    typedef EOS_H##CallNamespace NativeHandle;                                                                         \
    typedef ::Redpoint::EOS::API::Templates::NativeCall::TAsyncWithImmediateErrorInfo<                                 \
    ...
    [[nodiscard]] static FORCEINLINE EOS_EResult NativeFunction(                                                       \
        NativeHandle Handle,                                                                                           \
...
#define REDPOINT_EOSSDK_API_CALL_ASYNC_WITH_IMMEDIATE_ERROR_END()                                                      \
