...
class REDPOINTEOSAPI_API FUnregisterPeer
{
    REDPOINT_EOSSDK_API_CALL_SYNC_BEGIN(AntiCheatClient, UnregisterPeer, EOS_ANTICHEATCLIENT_UNREGISTERPEER_API_LATEST)
