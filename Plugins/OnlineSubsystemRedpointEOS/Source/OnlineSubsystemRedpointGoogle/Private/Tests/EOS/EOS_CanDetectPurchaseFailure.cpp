...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FOnlineSubsystemRedpointGoogle_EOS_CanDetectPurchaseFailure,
    "OnlineSubsystemRedpointGoogle.EOS.CanDetectPurchaseFailure",
    EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter);

bool FOnlineSubsystemRedpointGoogle_EOS_CanDetectPurchaseFailure::RunTest(const FString &InParam)
{
