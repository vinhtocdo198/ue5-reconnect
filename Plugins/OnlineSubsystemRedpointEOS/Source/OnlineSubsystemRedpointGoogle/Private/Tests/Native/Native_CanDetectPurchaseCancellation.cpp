...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FOnlineSubsystemRedpointGoogle_Native_CanDetectPurchaseCancellation,
    "OnlineSubsystemRedpointGoogle.Native.CanDetectPurchaseCancellation",
    EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter);

bool FOnlineSubsystemRedpointGoogle_Native_CanDetectPurchaseCancellation::RunTest(const FString &InParam)
{
    ...
    FAutomationTestFramework::Get().EnqueueLatentCommand(MakeShareable(new FRedpointGoogleCheckout(
        ...
        CheckoutWithItem,
        EPurchaseTransactionState::Canceled)));
