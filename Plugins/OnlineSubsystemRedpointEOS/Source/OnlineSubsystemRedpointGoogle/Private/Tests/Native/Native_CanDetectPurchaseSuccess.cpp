...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FOnlineSubsystemRedpointGoogle_Native_CanDetectPurchaseSuccess,
    "OnlineSubsystemRedpointGoogle.Native.CanDetectPurchaseSuccess",
    EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter);

bool FOnlineSubsystemRedpointGoogle_Native_CanDetectPurchaseSuccess::RunTest(const FString &InParam)
{
