...
IMPLEMENT_MATCHMAKING_AUTOMATION_TEST(
    FMatchmaking_WithThreeHostsIn2v1,
    "Redpoint.Matchmaking.WithThreeHostsIn2v1",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter,
    3);

FMatchmakingEngineRequestHandle FMatchmaking_WithThreeHostsIn2v1::QueueRequestForInstance(
    int InstanceIdx,
