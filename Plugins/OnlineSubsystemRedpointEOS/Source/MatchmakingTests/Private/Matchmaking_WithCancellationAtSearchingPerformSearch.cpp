...
IMPLEMENT_MATCHMAKING_PARTY_AUTOMATION_TEST(
    FMatchmaking_WithCancellationAtSearchingPerformSearch,
    "Redpoint.Matchmaking.WithCancellationAtSearchingPerformSearch",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter,
    "3:2:2:1:1:1:1");

FMatchmakingEngineRequestHandle FMatchmaking_WithCancellationAtSearchingPerformSearch::QueueRequestForInstance(
    int InstanceIdx,
    ...
    Request.CompletionBehaviour.OnComplete =
        FMatchmakingEngineRequestComplete::CreateLambda([this, InstanceIdx, Instances, OnDone](
            ...
            this->TestFalse(
                ...
                InstanceIdx == 0 || InstanceIdx == 1 || InstanceIdx == 2);
    ...
    Request.OnProgress = FMatchmakingEngineRequestProgress::CreateLambda(
        [InstanceIdx,
         this](const FString &TaskId, const FMatchmakingEngineRequest &, FMatchmakingEngineProgressInfo ProgressInfo) {
            ...
            if (InstanceIdx == 0 && ProgressInfo.StepName.ToString() == TEXT("SearchingPerformSearch"))
            {
