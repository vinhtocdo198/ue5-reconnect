...
IMPLEMENT_MATCHMAKING_PARTY_AUTOMATION_TEST(
    FMatchmaking_WithThreeHostsIn2v1InParty,
    "Redpoint.Matchmaking.WithThreeHostsIn2v1InParty",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter,
    "2:1");

FMatchmakingEngineRequestHandle FMatchmaking_WithThreeHostsIn2v1InParty::QueueRequestForInstance(
    int InstanceIdx,
