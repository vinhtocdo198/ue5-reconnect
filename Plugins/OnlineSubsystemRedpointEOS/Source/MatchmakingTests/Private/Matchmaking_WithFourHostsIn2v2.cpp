...
IMPLEMENT_MATCHMAKING_AUTOMATION_TEST(
    FMatchmaking_WithFourHostsIn2v2,
    "Redpoint.Matchmaking.WithFourHostsIn2v2",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter,
    4);

FMatchmakingEngineRequestHandle FMatchmaking_WithFourHostsIn2v2::QueueRequestForInstance(
    int InstanceIdx,
