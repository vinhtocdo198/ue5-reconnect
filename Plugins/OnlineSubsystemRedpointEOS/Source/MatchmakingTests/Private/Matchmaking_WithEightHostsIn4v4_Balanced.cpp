...
IMPLEMENT_MATCHMAKING_AUTOMATION_TEST(
    FMatchmaking_WithEightHostsIn4v4_Balanced,
    "Redpoint.Matchmaking.WithEightHostsIn4v4_Balanced",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter,
    8);

FMatchmakingEngineRequestHandle FMatchmaking_WithEightHostsIn4v4_Balanced::QueueRequestForInstance(
    int InstanceIdx,
    ...
    FMatchmakingRequestComplete OnDone)
{
    ...
    Request.CompletionBehaviour.OnComplete =
        FMatchmakingEngineRequestComplete::CreateLambda([this, InstanceIdx, Instances, OnDone](
            ...
            ASSERT_MM_SLOT_USER(0, 2, 6);
            ASSERT_MM_SLOT_USER(0, 3, 5);
            ASSERT_MM_SLOT_USER(1, 0, 1);
            ASSERT_MM_SLOT_USER(1, 1, 2);
            ASSERT_MM_SLOT_USER(1, 2, 7);
