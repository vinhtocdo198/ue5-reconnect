...
IMPLEMENT_MATCHMAKING_AUTOMATION_TEST(
    FMatchmaking_WithEightHostsIn4v4,
    "Redpoint.Matchmaking.WithEightHostsIn4v4",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter,
    8);

FMatchmakingEngineRequestHandle FMatchmaking_WithEightHostsIn4v4::QueueRequestForInstance(
    int InstanceIdx,
    ...
    FMatchmakingRequestComplete OnDone)
{
    ...
    Request.CompletionBehaviour.OnComplete =
        FMatchmakingEngineRequestComplete::CreateLambda([this, InstanceIdx, Instances, OnDone](
            ...
            ASSERT_MM_SLOT_USER(0, 2, 3);
            ASSERT_MM_SLOT_USER(0, 3, 2);
            ASSERT_MM_SLOT_USER(1, 0, 7);
            ASSERT_MM_SLOT_USER(1, 1, 6);
            ASSERT_MM_SLOT_USER(1, 2, 5);
            ASSERT_MM_SLOT_USER(1, 3, 4);
