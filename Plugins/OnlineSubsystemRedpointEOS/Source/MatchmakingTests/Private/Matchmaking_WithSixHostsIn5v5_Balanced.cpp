...
IMPLEMENT_MATCHMAKING_AUTOMATION_TEST_DELAYED(
    FMatchmaking_WithSixHostsIn5v5_Balanced,
    "Redpoint.Matchmaking.WithSixHostsIn5v5_Balanced",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter,
    6);

FMatchmakingEngineRequestHandle FMatchmaking_WithSixHostsIn5v5_Balanced::QueueRequestForInstance(
    int InstanceIdx,
