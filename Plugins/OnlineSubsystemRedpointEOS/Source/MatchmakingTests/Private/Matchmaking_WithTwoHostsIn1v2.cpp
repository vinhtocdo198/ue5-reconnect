...
IMPLEMENT_MATCHMAKING_AUTOMATION_TEST(
    FMatchmaking_WithTwoHostsIn1v2,
    "Redpoint.Matchmaking.WithTwoHostsIn1v2",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter,
    2);

FMatchmakingEngineRequestHandle FMatchmaking_WithTwoHostsIn1v2::QueueRequestForInstance(
    int InstanceIdx,
