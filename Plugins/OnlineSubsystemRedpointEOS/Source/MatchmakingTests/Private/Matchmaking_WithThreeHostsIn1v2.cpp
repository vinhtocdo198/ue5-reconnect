...
IMPLEMENT_MATCHMAKING_AUTOMATION_TEST(
    FMatchmaking_WithThreeHostsIn1v2,
    "Redpoint.Matchmaking.WithThreeHostsIn1v2",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter,
    3);

FMatchmakingEngineRequestHandle FMatchmaking_WithThreeHostsIn1v2::QueueRequestForInstance(
    int InstanceIdx,
