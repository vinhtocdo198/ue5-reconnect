...
#include "RedpointFriendListUnblockPlayerAsyncAction.h"
...
URedpointFriendListUnblockPlayerAsyncAction *URedpointFriendListUnblockPlayerAsyncAction::UnblockPlayer(
    URedpointFriendListEntry *FriendListEntry)
{
    URedpointFriendListUnblockPlayerAsyncAction *Node = NewObject<URedpointFriendListUnblockPlayerAsyncAction>();
    Node->Entry = FriendListEntry;
    return Node;
}

void URedpointFriendListUnblockPlayerAsyncAction::Activate()
{
...
::Redpoint::EOS::Async::TTask<void> URedpointFriendListUnblockPlayerAsyncAction::ActivateInternal()
{
    ...
    IFriendSystem::FUnblockPlayerResult Result = co_await TTask<IFriendSystem::FUnblockPlayerResult>::FromFuture(
        FriendSystem->UnblockPlayer(Entry->BoundForLocalUserId, GetAccountId(this->Entry->UserId)));
