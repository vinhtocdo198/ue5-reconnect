...
#include "RedpointFriendListKickFromPartyAsyncAction.h"
...
URedpointFriendListKickFromPartyAsyncAction *URedpointFriendListKickFromPartyAsyncAction::KickFromParty(
    URedpointFriendListEntry *FriendListEntry)
{
    URedpointFriendListKickFromPartyAsyncAction *Node = NewObject<URedpointFriendListKickFromPartyAsyncAction>();
    Node->Entry = FriendListEntry;
    return Node;
}

void URedpointFriendListKickFromPartyAsyncAction::Activate()
{
            ...
            *Entry->UserId,
            FOnKickPartyMemberComplete::CreateWeakLambda(
                ...
                [this](
                    ...
                    const FUniqueNetId &,
                    const EKickMemberCompletionResult) {
