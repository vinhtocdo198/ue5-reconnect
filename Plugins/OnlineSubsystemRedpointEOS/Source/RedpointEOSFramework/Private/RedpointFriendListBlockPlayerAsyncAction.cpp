...
#include "RedpointFriendListBlockPlayerAsyncAction.h"
...
URedpointFriendListBlockPlayerAsyncAction *URedpointFriendListBlockPlayerAsyncAction::BlockPlayer(
    URedpointFriendListEntry *FriendListEntry)
{
    URedpointFriendListBlockPlayerAsyncAction *Node = NewObject<URedpointFriendListBlockPlayerAsyncAction>();
    Node->Entry = FriendListEntry;
    return Node;
}

void URedpointFriendListBlockPlayerAsyncAction::Activate()
{
...
::Redpoint::EOS::Async::TTask<void> URedpointFriendListBlockPlayerAsyncAction::ActivateInternal()
{
    ...
    IFriendSystem::FBlockPlayerResult Result = co_await TTask<IFriendSystem::FBlockPlayerResult>::FromFuture(
        FriendSystem->BlockPlayer(Entry->BoundForLocalUserId, GetAccountId(this->Entry->UserId)));
