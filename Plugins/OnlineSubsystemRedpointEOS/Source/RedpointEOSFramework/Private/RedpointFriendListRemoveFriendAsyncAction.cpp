...
#include "RedpointFriendListRemoveFriendAsyncAction.h"
...
URedpointFriendListRemoveFriendAsyncAction *URedpointFriendListRemoveFriendAsyncAction::RemoveFriend(
    URedpointFriendListEntry *FriendListEntry)
{
    URedpointFriendListRemoveFriendAsyncAction *Node = NewObject<URedpointFriendListRemoveFriendAsyncAction>();
    Node->Entry = FriendListEntry;
    return Node;
}

void URedpointFriendListRemoveFriendAsyncAction::Activate()
{
...
::Redpoint::EOS::Async::TTask<void> URedpointFriendListRemoveFriendAsyncAction::ActivateInternal()
{
    ...
    IFriendSystem::FDeleteFriendResult Result = co_await TTask<IFriendSystem::FDeleteFriendResult>::FromFuture(
        FriendSystem->DeleteFriend(Entry->BoundForLocalUserId, GetAccountId(this->Entry->UserId)));
