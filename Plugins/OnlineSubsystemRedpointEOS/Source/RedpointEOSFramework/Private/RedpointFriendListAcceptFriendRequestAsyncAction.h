...
#include "RedpointFriendListAcceptFriendRequestAsyncAction.generated.h"

REDPOINT_EOS_CODE_GUARD_BEGIN_UOBJECT()

UCLASS()
class REDPOINTEOSFRAMEWORK_API URedpointFriendListAcceptFriendRequestAsyncAction : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
...
public:
    ...
    /**
     * Accepts the friend request based on the friend list entry.
     *
     * This blueprint node is intended to be used with friend list entries returned by the "Redpoint EOS Online
     * Framework Local Player Subsystem". If you want to accept friend requests from arbitrary users or are building
    ...
    UFUNCTION(
        ...
        meta = (DisplayName = "Accept Friend Request from Friend List Entry", BlueprintInternalUseOnly = "true"))
    static URedpointFriendListAcceptFriendRequestAsyncAction *AcceptFriendRequest(
