...
#include "RedpointFriendListBlockPlayerAsyncAction.generated.h"

REDPOINT_EOS_CODE_GUARD_BEGIN_UOBJECT()

UCLASS()
class REDPOINTEOSFRAMEWORK_API URedpointFriendListBlockPlayerAsyncAction : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
...
public:
    ...
    /**
     * Blocks a player based on a friend list entry.
     *
     * This blueprint node is intended to be used with friend list entries returned by the "Redpoint EOS Online
     * Framework Local Player Subsystem". If you want to block arbitrary users or are building your own
    ...
    UFUNCTION(
        ...
        meta = (DisplayName = "Block Friend List Entry", BlueprintInternalUseOnly = "true"))
    static URedpointFriendListBlockPlayerAsyncAction *BlockPlayer(URedpointFriendListEntry *FriendListEntry);
