...
class FStorageConfigurator : public IConfigurator
{
public:
    FStorageConfigurator() = default;
    UE_NONCOPYABLE(FStorageConfigurator);
    virtual ~FStorageConfigurator() override = default;
...
{
REDPOINT_EOS_FILE_NS_EXPORT(428911753, Redpoint::EOS::Editor::Config::Configurators, FStorageConfigurator);
}
