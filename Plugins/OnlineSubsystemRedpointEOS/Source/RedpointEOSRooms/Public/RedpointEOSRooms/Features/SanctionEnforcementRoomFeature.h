...
class REDPOINTEOSROOMS_API ISanctionEnforcementRoomFeature : public IRoomFeature
{
public:
...
{
REDPOINT_EOS_FILE_NS_EXPORT(207573021, Redpoint::EOS::Rooms::Features, ISanctionEnforcementRoomFeature)
}
