...
class REDPOINTEOSROOMS_API IPublicMemberListRoomFeature : public IRoomFeature
{
public:
...
{
REDPOINT_EOS_FILE_NS_EXPORT(621398794, Redpoint::EOS::Rooms::Features, IPublicMemberListRoomFeature)
}
