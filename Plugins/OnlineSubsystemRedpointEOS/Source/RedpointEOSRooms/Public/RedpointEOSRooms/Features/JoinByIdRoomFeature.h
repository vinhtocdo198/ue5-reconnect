...
class REDPOINTEOSROOMS_API IJoinByIdRoomFeature : public IRoomFeature
{
public:
...
{
REDPOINT_EOS_FILE_NS_EXPORT(3899617978, Redpoint::EOS::Rooms::Features, IJoinByIdRoomFeature)
}
