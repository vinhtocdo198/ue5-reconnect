...
class REDPOINTEOSAUTH_API FSimpleFirstPartyCrossPlatformAccountProvider : public ICrossPlatformAccountProvider
{
public:
    FSimpleFirstPartyCrossPlatformAccountProvider() = default;
