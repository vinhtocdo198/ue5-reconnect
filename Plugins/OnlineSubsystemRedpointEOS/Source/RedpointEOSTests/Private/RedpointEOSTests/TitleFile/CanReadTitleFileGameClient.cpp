...
namespace REDPOINT_EOS_FILE_NS_ID(1813414105, Redpoint::EOS::Tests::TitleFile)
{
using namespace ::Redpoint::EOS::Tests::TitleFile;

IMPLEMENT_ASYNC_AUTOMATION_TEST(
    FOnlineSubsystemEOS_TitleFile_CanReadTitleFileGameClient,
    "Redpoint.EOS.TitleFile.CanReadTitleFileGameClient",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext |
        EAutomationTestFlags::ProductFilter);

void FOnlineSubsystemEOS_TitleFile_CanReadTitleFileGameClient::RunAsyncTest(const TFunction<void()> &OnDone)
{
