...
namespace REDPOINT_EOS_FILE_NS_ID(2228538172, Redpoint::EOS::Tests::Storage)
{

IMPLEMENT_ASYNC_AUTOMATION_TEST(
    FOnlineSubsystemEOS_Storage_TitleStorage_ReadFileDedicated,
    "Redpoint.EOS.Storage.TitleStorage.ReadFileDedicated",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext |
        EAutomationTestFlags::ProductFilter);

void FOnlineSubsystemEOS_Storage_TitleStorage_ReadFileDedicated::RunAsyncTest(const TFunction<void()> &OnDone)
{
