...
namespace REDPOINT_EOS_FILE_NS_ID(188395684, Redpoint::EOS::Tests::TitleStorage)
{
...
IMPLEMENT_ASYNC_AUTOMATION_TEST(
    FOnlineSubsystemEOS_TitleStorage_ReadFileDedicated,
    "Redpoint.EOS.TitleStorage.ReadFileDedicated",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext |
        EAutomationTestFlags::ProductFilter);

void FOnlineSubsystemEOS_TitleStorage_ReadFileDedicated::RunAsyncTest(const TFunction<void()> &OnDone)
{
    ...
    Executor->Then<FLambdaChainedTask>([](const FChainedTaskContextRef &Context,
        ...
        FReadFile::Execute(
            ...
            FReadFile::Options{static_cast<EOS_ProductUserId>(nullptr), TEXT("TestFile.Small.txt"), 256},
