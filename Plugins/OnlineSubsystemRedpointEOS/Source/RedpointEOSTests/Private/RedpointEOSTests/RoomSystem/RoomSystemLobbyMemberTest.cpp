...
namespace REDPOINT_EOS_FILE_NS_ID(2010491650, Redpoint::EOS::Tests::RoomSystem)
{
using namespace ::Redpoint::EOS::Tests::RoomSystem;

IMPLEMENT_ASYNC_AUTOMATION_TEST(
    FOnlineSubsystemEOS_RoomSystem_LobbyMember,
    "Redpoint.EOS.RoomSystem.LobbyMember",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext |
        EAutomationTestFlags::ProductFilter);

void FOnlineSubsystemEOS_RoomSystem_LobbyMember::RunAsyncTest(const TFunction<void()> &OnDone)
{
