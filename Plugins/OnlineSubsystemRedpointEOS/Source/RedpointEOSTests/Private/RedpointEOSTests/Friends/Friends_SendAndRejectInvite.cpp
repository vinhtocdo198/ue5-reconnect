...
namespace REDPOINT_EOS_FILE_NS_ID(3794643784, Redpoint::EOS::Tests::Friends)
{
...
IMPLEMENT_ASYNC_AUTOMATION_TEST(
    FOnlineSubsystemEOS_Friends_SendInviteAndReject,
    "Redpoint.EOS.Friends.SendInviteAndReject",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext |
        EAutomationTestFlags::ProductFilter);

void FOnlineSubsystemEOS_Friends_SendInviteAndReject::RunAsyncTest(const TFunction<void()> &OnDone)
{
    ...
    // Reject the invite as the target user.
    Executor->Then<FRejectFriendInviteChainedTask>(1, 0);
