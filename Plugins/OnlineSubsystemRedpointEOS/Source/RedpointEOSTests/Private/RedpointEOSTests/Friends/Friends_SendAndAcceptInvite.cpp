...
namespace REDPOINT_EOS_FILE_NS_ID(526163072, Redpoint::EOS::Tests::Friends)
{
...
IMPLEMENT_ASYNC_AUTOMATION_TEST(
    FOnlineSubsystemEOS_Friends_SendInviteAndAccept,
    "Redpoint.EOS.Friends.SendInviteAndAccept",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext |
        EAutomationTestFlags::ProductFilter);

void FOnlineSubsystemEOS_Friends_SendInviteAndAccept::RunAsyncTest(const TFunction<void()> &OnDone)
{
