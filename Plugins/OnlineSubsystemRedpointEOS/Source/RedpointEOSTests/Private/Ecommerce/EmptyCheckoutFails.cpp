...
IMPLEMENT_ASYNC_AUTOMATION_TEST(
    FOnlineSubsystemRedpointEAS_EmptyCheckoutFails,
    "OnlineSubsystemRedpointEAS.EmptyCheckoutFails",
    EAutomationTestFlags::ClientContext | EAutomationTestFlags::ProductFilter);

void FOnlineSubsystemRedpointEAS_EmptyCheckoutFails::RunAsyncTest(const TFunction<void()> &OnDone)
{
