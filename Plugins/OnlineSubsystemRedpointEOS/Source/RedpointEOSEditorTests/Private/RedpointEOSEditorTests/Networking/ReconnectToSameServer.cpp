...
namespace REDPOINT_EOS_FILE_NS_ID(2838820117, Redpoint::EOS::Editor::Tests::Networking)
{
...
static void ReconnectToSameServer_RunAsyncTest(
    ...
    const TFunction<void()> &OnDone)
{
    ...
    Executor->Then<FConnectClientPIEToHostPIEChainedTask>(0, 2, TestHelpers::Port(9000));
    Executor->Then<FConnectClientPIEToHostPIEChainedTask>(1, 2, TestHelpers::Port(9001));
    Executor->Then<FConnectClientPIEToHostPIEChainedTask>(0, 2, TestHelpers::Port(9000));
...
IMPLEMENT_ASYNC_AUTOMATION_TEST(
    FReconnectToSameServer_OverIP,
    "Redpoint.EOS.Networking.OverIP.ReconnectToSameServer",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter);

void FReconnectToSameServer_OverIP::RunAsyncTest(const TFunction<void()> &OnDone)
{
    ReconnectToSameServer_RunAsyncTest(this, TEXT("NetMode=ForceIP"), OnDone);
}

IMPLEMENT_ASYNC_AUTOMATION_TEST(
    FReconnectToSameServer_OverP2P,
    "Redpoint.EOS.Networking.OverP2P.ReconnectToSameServer",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter);

void FReconnectToSameServer_OverP2P::RunAsyncTest(const TFunction<void()> &OnDone)
{
    ReconnectToSameServer_RunAsyncTest(this, TEXT("NetMode=ForceP2P"), OnDone);
}
