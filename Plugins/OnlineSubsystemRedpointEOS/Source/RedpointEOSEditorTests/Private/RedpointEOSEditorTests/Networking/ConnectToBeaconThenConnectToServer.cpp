...
namespace REDPOINT_EOS_FILE_NS_ID(2638571420, Redpoint::EOS::Editor::Tests::Networking)
{
...
static void ConnectToBeaconThenConnectToServer_RunAsyncTest(
    ...
    const TFunction<void()> &OnDone)
{
    ...
    Executor->Then<FSpawnBeaconOnPIEChainedTask>(BeaconHost1, BeaconHostObject1, 0, TestHelpers::Port(9001), NetMode);

    Executor->Then<FConnectClientPIEToHostPIEBeaconChainedTask>(BeaconClientTo1, 0, 1, TestHelpers::Port(9001));
...
IMPLEMENT_ASYNC_AUTOMATION_TEST(
    ...
    "Redpoint.EOS.Networking.OverIP.ConnectToBeaconThenConnectToServer",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter);

void FConnectToBeaconThenConnectToServer_OverIP::RunAsyncTest(const TFunction<void()> &OnDone)
{
    ConnectToBeaconThenConnectToServer_RunAsyncTest(this, TEXT("NetMode=ForceIP"), OnDone);
}

IMPLEMENT_ASYNC_AUTOMATION_TEST(
    FConnectToBeaconThenConnectToServer_OverP2P,
    "Redpoint.EOS.Networking.OverP2P.ConnectToBeaconThenConnectToServer",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter);

void FConnectToBeaconThenConnectToServer_OverP2P::RunAsyncTest(const TFunction<void()> &OnDone)
{
    ConnectToBeaconThenConnectToServer_RunAsyncTest(this, TEXT("NetMode=ForceP2P"), OnDone);
}
