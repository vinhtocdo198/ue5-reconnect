...
class FWaitForClientBeaconToDestroyItselfAfterPingChainedTask
    : public FChainedTask,
      public TSharedFromThis<FWaitForClientBeaconToDestroyItselfAfterPingChainedTask>
{
private:
    TSharedRef<TSoftObjectPtr<ARedpointEOSTestBeaconControlledClient>> BeaconClient;

public:
    FWaitForClientBeaconToDestroyItselfAfterPingChainedTask(
        TSharedRef<TSoftObjectPtr<ARedpointEOSTestBeaconControlledClient>> InBeaconClient);
    UE_NONCOPYABLE(FWaitForClientBeaconToDestroyItselfAfterPingChainedTask);
    virtual ~FWaitForClientBeaconToDestroyItselfAfterPingChainedTask() override = default;
