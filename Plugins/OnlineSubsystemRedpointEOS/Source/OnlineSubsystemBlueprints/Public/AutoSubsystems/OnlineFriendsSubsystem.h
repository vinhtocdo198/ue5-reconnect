...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(
    FFriends_RejectInviteComplete_BP,
    int32,
    LocalUserNum,
    bool,
    bWasSuccessful,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(
    FFriends_DeleteFriendComplete_BP,
    int32,
    LocalUserNum,
    bool,
    bWasSuccessful,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(
    FFriends_BlockedPlayerComplete_BP,
    int32,
    LocalUserNum,
    bool,
    bWasSuccessful,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(
    FFriends_UnblockedPlayerComplete_BP,
    int32,
    LocalUserNum,
    bool,
    bWasSuccessful,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FFriends_QueryRecentPlayersComplete_BP,
    const FUniqueNetIdRepl &,
    UserId,
    const FString &,
    Namespace,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FFriends_QueryBlockedPlayersComplete_BP,
    const FUniqueNetIdRepl &,
    UserId,
    bool,
    bWasSuccessful,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FFriends_RecentPlayersAdded_BP,
    const FUniqueNetIdRepl &,
    UserId,
    const TArray<UOnlineRecentPlayerRef *> &,
    AddedPlayers);

DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(
    FFriends_FriendSettingsUpdated_BP,
    const FUniqueNetIdRepl &,
    UserId,
    bool,
    bWasSuccessful,
...
private:
    ...
    FDelegateHandle DelegateHandle_OnFriendSettingsUpdated;
...
public:
    ...
    UPROPERTY(BlueprintAssignable, Category = "Online|Friends")
    FFriends_FriendSettingsUpdated_BP OnFriendSettingsUpdated;
    ...
    bool GetFriendsList(int32 LocalUserNum, const FString &ListName, TArray<UOnlineFriendRef *> &OutFriends);

    UFUNCTION(BlueprintCallable, Category = "Online|Friends")
    UOnlineFriendRef *GetFriend(int32 LocalUserNum, const FUniqueNetIdRepl &FriendId, const FString &ListName);

    UFUNCTION(BlueprintCallable, Category = "Online|Friends")
    bool IsFriend(int32 LocalUserNum, const FUniqueNetIdRepl &FriendId, const FString &ListName);
    ...
    UFUNCTION(BlueprintCallable, Category = "Online|Friends")
    bool GetBlockedPlayers(const FUniqueNetIdRepl &UserId, TArray<UOnlineUserRef *> &OutBlockedPlayers);
    ...
    // void UpdateFriendInvitePolicySettings(const FUniqueNetId& LocalUserId, const EFriendInvitePolicy
    // FriendInvitePolicy, const bool bAffectsExistingInvites, FOnSettingsOperationComplete Delegate);
    ...
    // @generator-incompatible
    // EFriendInvitePolicy GetFriendInvitePolicy(const FUniqueNetId& UserId);

    friend class UOnlineFriendsSubsystemSetFriendSettings;
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FOnlineFriendsSubsystemReadFriendsListCallbackPin,
    int32,
    LocalUserNum,
    bool,
    bWasSuccessful,
...
private:
    UPROPERTY()
    TObjectPtr<UOnlineFriendsSubsystem> __Store__Subsystem;
    UPROPERTY()
    FString __Store__CallUniquenessId;
    void HandleCallback_OnReadFriendsListComplete(
        int32 LocalUserNum,
        bool bWasSuccessful,
        const FString &ListName,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FOnlineFriendsSubsystemDeleteFriendsListCallbackPin,
    int32,
    LocalUserNum,
    bool,
    bWasSuccessful,
...
private:
    ...
    UPROPERTY()
    FString __Store__CallUniquenessId;
    void HandleCallback_OnDeleteFriendsListComplete(
        int32 LocalUserNum,
        bool bWasSuccessful,
        const FString &ListName,
        const FString &ErrorStr);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(
    FOnlineFriendsSubsystemSendInviteCallbackPin,
    int32,
    LocalUserNum,
    bool,
    bWasSuccessful,
...
private:
    ...
    UPROPERTY()
    FString __Store__CallUniquenessId;
    void HandleCallback_OnSendInviteComplete(
        int32 LocalUserNum,
        bool bWasSuccessful,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(
    FOnlineFriendsSubsystemAcceptInviteCallbackPin,
    int32,
    LocalUserNum,
    bool,
    bWasSuccessful,
...
private:
    ...
    UPROPERTY()
    FString __Store__CallUniquenessId;
    void HandleCallback_OnAcceptInviteComplete(
        int32 LocalUserNum,
        bool bWasSuccessful,
        const FUniqueNetId &FriendId,
        const FString &ListName,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FOnlineFriendsSubsystemRejectInviteCallbackPin,
    bool,
    bWasSuccessful,
    const FUniqueNetIdRepl &,
    FriendId,
...
private:
    ...
    void HandleCallback_OnRejectInviteComplete(
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FOnlineFriendsSubsystemSetFriendAliasCallbackPin,
    int32,
    LocalUserNum,
    const FUniqueNetIdRepl &,
    FriendId,
...
private:
    ...
    UPROPERTY()
    FString __Store__CallUniquenessId;
    void HandleCallback_OnSetFriendAliasComplete(
        int32 LocalUserNum,
        const FUniqueNetId &FriendId,
        const FString &ListName,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FOnlineFriendsSubsystemDeleteFriendAliasCallbackPin,
    int32,
    LocalUserNum,
    const FUniqueNetIdRepl &,
    FriendId,
...
private:
    ...
    UPROPERTY()
    FString __Store__CallUniquenessId;
    void HandleCallback_OnDeleteFriendAliasComplete(
        int32 LocalUserNum,
        const FUniqueNetId &FriendId,
        const FString &ListName,
        const FOnlineError &Error);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FOnlineFriendsSubsystemDeleteFriendCallbackPin,
    bool,
    bWasSuccessful,
    const FUniqueNetIdRepl &,
    FriendId,
...
private:
    ...
    void HandleCallback_OnDeleteFriendComplete(
        int32 LocalUserNumCb,
        bool bWasSuccessful,
        const FUniqueNetId &FriendId,
        const FString &ListName,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineFriendsSubsystemAddRecentPlayersCallbackPin,
    const FUniqueNetIdRepl &,
    UserId,
    const FOnlineErrorInfo &,
    Error);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FOnlineFriendsSubsystemQueryRecentPlayersCallbackPin,
    const FUniqueNetIdRepl &,
    UserId,
    const FString &,
    Namespace,
...
private:
    ...
    FString __Store__CallUniquenessId;
    FDelegateHandle DelegateHandle_OnQueryRecentPlayersComplete;
    void HandleCallback_OnQueryRecentPlayersComplete(
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FOnlineFriendsSubsystemBlockPlayerCallbackPin,
    bool,
    bWasSuccessful,
    const FUniqueNetIdRepl &,
    UniqueId,
...
private:
    ...
    void HandleCallback_OnBlockedPlayerComplete(
        int32 LocalUserNumCb,
        bool bWasSuccessful,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FOnlineFriendsSubsystemUnblockPlayerCallbackPin,
    bool,
    bWasSuccessful,
    const FUniqueNetIdRepl &,
    UniqueId,
...
private:
    ...
    void HandleCallback_OnUnblockedPlayerComplete(
        int32 LocalUserNumCb,
        bool bWasSuccessful,
        const FUniqueNetId &UniqueId,
        const FString &ListName,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FOnlineFriendsSubsystemQueryBlockedPlayersCallbackPin,
    const FUniqueNetIdRepl &,
    UserId,
    bool,
    bWasSuccessful,
...
private:
    ...
    FString __Store__CallUniquenessId;
    FDelegateHandle DelegateHandle_OnQueryBlockedPlayersComplete;
    void HandleCallback_OnQueryBlockedPlayersComplete(
        const FUniqueNetId &UserId,
        bool bWasSuccessful,
        const FString &Error);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(
    FOnlineFriendsSubsystemQueryFriendSettingsCallbackPin,
    const FUniqueNetIdRepl &,
    UserId,
    bool,
    bWasSuccessful,
...
private:
    ...
    UPROPERTY()
    FString __Store__CallUniquenessId;
    void HandleCallback_OnSettingsOperationComplete(
        const FUniqueNetId &UserId,
        bool bWasSuccessful,
        bool bWasUpdate,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FOnlineFriendsSubsystemSetFriendSettingsCallbackPin,
    const FUniqueNetIdRepl &,
    Param1,
    bool,
    Param2,
