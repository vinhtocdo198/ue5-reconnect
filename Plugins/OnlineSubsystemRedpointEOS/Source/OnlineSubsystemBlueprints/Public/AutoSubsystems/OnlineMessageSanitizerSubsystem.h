...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineMessageSanitizerSubsystemSanitizeDisplayNameCallbackPin,
    bool,
    bSuccess,
    const FString &,
    SanitizedMessage);
...
UCLASS()
class ONLINESUBSYSTEMBLUEPRINTS_API UOnlineMessageSanitizerSubsystemSanitizeDisplayName
...
private:
    UPROPERTY()
    TObjectPtr<UOnlineMessageSanitizerSubsystem> __Store__Subsystem;
    UPROPERTY()
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineMessageSanitizerSubsystemSanitizeDisplayNamesCallbackPin,
    bool,
    bSuccess,
...
UCLASS()
class ONLINESUBSYSTEMBLUEPRINTS_API UOnlineMessageSanitizerSubsystemSanitizeDisplayNames
    : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(
    FOnlineMessageSanitizerSubsystemQueryBlockedUserCallbackPin,
    const FBlockedQueryResultInfo &,
    QueryResult);
