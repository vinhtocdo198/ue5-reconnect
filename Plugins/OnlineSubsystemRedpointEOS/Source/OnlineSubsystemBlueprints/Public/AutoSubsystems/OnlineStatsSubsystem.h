...
public:
    ...
    // void QueryStats(const FUniqueNetIdRef LocalUserId, const FUniqueNetIdRef StatsUser);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineStatsSubsystemQueryStatsCallbackPin,
    const FOnlineErrorInfo &,
    ResultState,
    const TArray<FOnlineStatsUserStatsBP> &,
    UsersStatsResult);
...
private:
    UPROPERTY()
    TObjectPtr<UOnlineStatsSubsystem> __Store__Subsystem;
    UPROPERTY()
    FString __Store__CallUniquenessId;
    void HandleCallback_OnlineStatsQueryUsersStatsComplete(
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(
    FOnlineStatsSubsystemUpdateStatsCallbackPin,
    const FOnlineErrorInfo &,
    ResultState);
