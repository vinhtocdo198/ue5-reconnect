...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FEntitlements_QueryEntitlementsComplete_BP,
    bool,
    bWasSuccessful,
...
public:
    ...
    UOnlineEntitlement *GetEntitlement(const FUniqueNetIdRepl &UserId, const FString &EntitlementId);

    UFUNCTION(BlueprintCallable, Category = "Online|Entitlements")
    UOnlineEntitlement *GetItemEntitlement(const FUniqueNetIdRepl &UserId, const FString &ItemId);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FOnlineEntitlementsSubsystemQueryEntitlementsCallbackPin,
    bool,
    bWasSuccessful,
    const FUniqueNetIdRepl &,
    UserId,
...
private:
    UPROPERTY()
    TObjectPtr<UOnlineEntitlementsSubsystem> __Store__Subsystem;
    UPROPERTY()
    FString __Store__CallUniquenessId;
    FDelegateHandle DelegateHandle_OnQueryEntitlementsComplete;
    void HandleCallback_OnQueryEntitlementsComplete(
        bool bWasSuccessful,
