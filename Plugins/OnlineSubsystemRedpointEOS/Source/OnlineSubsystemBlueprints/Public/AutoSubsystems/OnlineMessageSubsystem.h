...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FMessage_EnumerateMessagesComplete_BP,
    int32,
    LocalUserNum,
    bool,
    Param1,
...
// DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FMessage_ReadMessageComplete_BP, int32, LocalUserNum, bool, Param1,
// const FUniqueMessageId&, Param2, const FString&, Param3);

DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FMessage_SendMessageComplete_BP,
    int32,
    LocalUserNum,
    bool,
    Param1,
...
// @parameters-not-compatible
// DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FMessage_DeleteMessageComplete_BP, int32, LocalUserNum, bool, Param1,
// const FUniqueMessageId&, Param2, const FString&, Param3);
...
public:
    ...
    // @generator-incompatible
    // bool SendMessage(int32 LocalUserNum, const TArray<FUniqueNetIdRef>& RecipientIds, const FString& MessageType,
