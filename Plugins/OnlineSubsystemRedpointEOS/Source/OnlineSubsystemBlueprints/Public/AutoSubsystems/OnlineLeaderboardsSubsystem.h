...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FLeaderboards_LeaderboardFlushComplete_BP,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Online|Leaderboards")
    bool WriteLeaderboards(FName SessionName, const FUniqueNetIdRepl &Player, UOnlineLeaderboardWrite *WriteObject);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(
    FOnlineLeaderboardsSubsystemReadLeaderboardsCallbackPin,
    bool,
    bWasSuccessful);
...
private:
    UPROPERTY()
    TObjectPtr<UOnlineLeaderboardsSubsystem> __Store__Subsystem;
    UPROPERTY()
    ...
    UPROPERTY()
    TObjectPtr<UOnlineLeaderboardRead> __Store__ReadObject;
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(
    FOnlineLeaderboardsSubsystemReadLeaderboardsForFriendsCallbackPin,
    bool,
    bWasSuccessful);

UCLASS()
class ONLINESUBSYSTEMBLUEPRINTS_API UOnlineLeaderboardsSubsystemReadLeaderboardsForFriends
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(
    FOnlineLeaderboardsSubsystemReadLeaderboardsAroundRankCallbackPin,
    bool,
    bWasSuccessful);

UCLASS()
class ONLINESUBSYSTEMBLUEPRINTS_API UOnlineLeaderboardsSubsystemReadLeaderboardsAroundRank
    : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(
    FOnlineLeaderboardsSubsystemReadLeaderboardsAroundUserCallbackPin,
    bool,
    bWasSuccessful);

UCLASS()
class ONLINESUBSYSTEMBLUEPRINTS_API UOnlineLeaderboardsSubsystemReadLeaderboardsAroundUser
    : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
