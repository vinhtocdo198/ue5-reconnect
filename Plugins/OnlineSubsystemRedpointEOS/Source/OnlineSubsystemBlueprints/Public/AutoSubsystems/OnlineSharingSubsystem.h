...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FSharing_RequestNewReadPermissionsComplete_BP,
    int32,
    LocalUserNum,
    bool,
    Param1);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FSharing_RequestNewPublishPermissionsComplete_BP,
    int32,
    LocalUserNum,
    bool,
    Param1);
...
public:
    ...
    // @result-delegates-not-compatible: FOnRequestCurrentPermissionsComplete(int32 LocalUserNum, bool bWasSuccessful,
    // const TArray<FSharingPermission>& Permissions) void RequestCurrentPermissions(int32 LocalUserNum);
    ...
    // @generator-incompatible
    // bool RequestNewPublishPermissions(int32 LocalUserNum, EOnlineSharingCategory NewPermissions,
    ...
    // @generator-incompatible
    // EOnlineCachedResult::Type GetCachedNewsFeed(int32 LocalUserNum, int32 NewsFeedIdx, FOnlineStatusUpdate&
    // OutNewsFeed);
