...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FSession_CreateSessionComplete_BP,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FSession_StartSessionComplete_BP,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FSession_UpdateSessionComplete_BP,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FSession_DestroySessionComplete_BP,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FSession_CancelMatchmakingComplete_BP,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FSession_JoinSessionComplete_BP,
    FName,
    SessionName,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FSession_SessionParticipantJoined_BP,
    FName,
    Param1,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FSession_SessionParticipantLeft_BP,
    FName,
    Param1,
    const FUniqueNetIdRepl &,
    Param2,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FSession_SessionSettingsUpdated_BP,
    FName,
    Param1,
    const FOnlineSessionSettingsBP &,
    Param2);

DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FSession_SessionParticipantSettingsUpdated_BP,
    FName,
    Param1,
    const FUniqueNetIdRepl &,
    Param2,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FSession_FindFriendSessionComplete_BP,
    int32,
    LocalUserNum,
    bool,
    bWasSuccessful,
    const TArray<FOnlineSessionSearchResultBP> &,
    FriendSearchResult);

DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FSession_SessionUserInviteAccepted_BP,
    bool,
    bWasSuccessful,
    int32,
    ControllerId,
    const FUniqueNetIdRepl &,
    UserId,
    const FOnlineSessionSearchResultBP &,
    InviteResult);

DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(
    FSession_SessionInviteReceived_BP,
    const FUniqueNetIdRepl &,
    UserId,
    const FUniqueNetIdRepl &,
    FromId,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FSession_RegisterPlayersComplete_BP,
    FName,
    SessionName,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FSession_UnregisterPlayersComplete_BP,
    FName,
    SessionName,
    const TArray<FUniqueNetIdRepl> &,
    PlayerIds,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FSession_DestroySessionRequested_BP,
    int32,
    LocalUserNum,
    FName,
    SessionName);
...
private:
    ...
    FDelegateHandle DelegateHandle_OnSessionParticipantJoined;
    FDelegateHandle DelegateHandle_OnSessionParticipantLeft;
    ...
    FDelegateHandle DelegateHandle_OnDestroySessionRequested;
...
public:
    ...
    UPROPERTY(BlueprintAssignable, Category = "Online|Session")
    FSession_SessionParticipantJoined_BP OnSessionParticipantJoined;

    UPROPERTY(BlueprintAssignable, Category = "Online|Session")
    FSession_SessionParticipantLeft_BP OnSessionParticipantLeft;
    ...
    UPROPERTY(BlueprintAssignable, Category = "Online|Session")
    FSession_DestroySessionRequested_BP OnDestroySessionRequested;

    UFUNCTION(BlueprintCallable, Category = "Online|Session")
    FUniqueNetIdRepl CreateSessionIdFromString(const FString &SessionIdStr);
    ...
    // bool StartMatchmaking(const TArray<FSessionMatchmakingUser>& LocalPlayers, FName SessionName, const
    // FOnlineSessionSettings& NewSessionSettings, TSharedRef<FOnlineSessionSearch>& SearchSettings, const
    ...
    // @generator-excluded-with-pick
    // bool FindSessionById(const FUniqueNetId& SearchingUserId, const FUniqueNetId& SessionId, const FUniqueNetId&
    // FriendId);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineSessionSubsystemCreateSessionCallbackPin,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
private:
    UPROPERTY()
    TObjectPtr<UOnlineSessionSubsystem> __Store__Subsystem;
    UPROPERTY()
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineSessionSubsystemStartSessionCallbackPin,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Online|Session", meta = (BlueprintInternalUseOnly = "true"))
    static UOnlineSessionSubsystemStartSession *StartSession(UOnlineSessionSubsystem *Subsystem, FName SessionName);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineSessionSubsystemUpdateSessionCallbackPin,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineSessionSubsystemEndSessionCallbackPin,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Online|Session", meta = (BlueprintInternalUseOnly = "true"))
    static UOnlineSessionSubsystemEndSession *EndSession(UOnlineSessionSubsystem *Subsystem, FName SessionName);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineSessionSubsystemDestroySessionCallbackPin,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Online|Session", meta = (BlueprintInternalUseOnly = "true"))
    static UOnlineSessionSubsystemDestroySession *DestroySession(UOnlineSessionSubsystem *Subsystem, FName SessionName);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineSessionSubsystemStartMatchmakingCallbackPin,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
private:
    ...
    UPROPERTY()
    TObjectPtr<UOnlineSessionSearch> __Store__SearchSettings;
};

DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineSessionSubsystemCancelMatchmakingCallbackPin,
    FName,
    SessionName,
    bool,
    bWasSuccessful);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FOnlineSessionSubsystemFindSessionByIdCallbackPin,
    int32,
    LocalUserNum,
    bool,
    bWasSuccessful,
...
private:
    ...
    UPROPERTY()
    FString __Store__CallUniquenessId;
    void HandleCallback_OnSingleSessionResultComplete(
        int32 LocalUserNum,
        bool bWasSuccessful,
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Online|Session", meta = (BlueprintInternalUseOnly = "true"))
    static UOnlineSessionSubsystemCancelFindSessions *CancelFindSessions(UOnlineSessionSubsystem *Subsystem
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineSessionSubsystemJoinSessionCallbackPin,
    FName,
    SessionName,
    EOnJoinSessionCompleteResult_,
    Result);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineSessionSubsystemFindFriendSessionCallbackPin,
    bool,
    bWasSuccessful,
    const TArray<FOnlineSessionSearchResultBP> &,
    FriendSearchResult);
...
private:
    ...
    void HandleCallback_OnFindFriendSessionComplete(
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FOnlineSessionSubsystemRegisterPlayersCallbackPin,
    FName,
    SessionName,
    const TArray<FUniqueNetIdRepl> &,
    PlayerIds,
...
private:
    ...
    FString __Store__CallUniquenessId;
    FDelegateHandle DelegateHandle_OnRegisterPlayersComplete;
    void HandleCallback_OnRegisterPlayersComplete(
        FName SessionName,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(
    FOnlineSessionSubsystemUnregisterPlayersCallbackPin,
    FName,
    SessionName,
    const TArray<FUniqueNetIdRepl> &,
    PlayerIds,
...
private:
    ...
    FString __Store__CallUniquenessId;
    FDelegateHandle DelegateHandle_OnUnregisterPlayersComplete;
    void HandleCallback_OnUnregisterPlayersComplete(
        FName SessionName,
        const TArray<FUniqueNetIdRef> &PlayerIds,
        bool bWasSuccessful);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineSessionSubsystemRegisterLocalPlayerCallbackPin,
    const FUniqueNetIdRepl &,
    Param1,
    EOnJoinSessionCompleteResult_,
    Param2);
...
private:
    ...
    UPROPERTY()
    FString __Store__CallUniquenessId;
    void HandleCallback_OnRegisterLocalPlayerComplete(
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
    FOnlineSessionSubsystemUnregisterLocalPlayerCallbackPin,
    const FUniqueNetIdRepl &,
    Param1,
    bool,
    Param2);
