...
#include "OSBOnlineUserRef.generated.h"
...
public:
     ...
     */
    UFUNCTION(BlueprintPure, Category = "Online")
    FString GetAuthAttribute(const FString &Key, bool &Found);

    /**
     * Sets an attribute of the user, and whether or not it could be set.
     */
    UFUNCTION(BlueprintPure, Category = "Online")
    bool SetUserAttribute(const FString &Key, const FString &Value);
};
