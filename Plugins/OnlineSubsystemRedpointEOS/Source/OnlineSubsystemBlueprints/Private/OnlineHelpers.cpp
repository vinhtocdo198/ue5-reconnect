...
FString UOnlineHelpers::Conv_FUniqueNetIdReplToString(const FUniqueNetIdRepl &InNetId)
{
    return InNetId.ToString();
}

FName UOnlineHelpers::GetCurrentSubsystemName(const UObject *WorldContextObject)
{
...
FName UOnlineHelpers::FUniqueNetIdGetType(const FUniqueNetIdRepl &InNetId)
{
    return InNetId.GetType();
}

bool UOnlineHelpers::FUniqueNetIdIsValid(const FUniqueNetIdRepl &InNetId)
{
...
FUniqueNetIdRepl UOnlineHelpers::GetPlayerStateUniqueNetId(APlayerState *InPlayerState)
{
    ...
    return FUniqueNetIdRepl(InPlayerState->GetUniqueId());
}
