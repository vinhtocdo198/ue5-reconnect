...
FName UOnlineExternalUISubsystem::OSSNameToAssignDuringConstruction = NAME_Default;
...
UOnlineExternalUISubsystem::UOnlineExternalUISubsystem()
{
    ...
    this->OSSName = UOnlineExternalUISubsystem::OSSNameToAssignDuringConstruction;
    ...
    UE_LOG(
        LogOnlineBlueprint,
        Verbose,
        TEXT("OnlineExternalUISubsystem subsystem initialized in context %s"),
...
UOnlineExternalUISubsystemShowLoginUI *UOnlineExternalUISubsystemShowLoginUI::ShowLoginUI(
    ...
    bool bShowSkipButton)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
            LogOnlineBlueprint,
            Error,
            TEXT("OnlineExternalUISubsystem is not available. It's possible the online subsystem you are using doesn't "
...
void UOnlineExternalUISubsystemShowLoginUI::Activate()
{
    ...
    auto __DelegateHandle_OnLoginUIClosed = FOnLoginUIClosedDelegate::CreateUObject(
        this,
        &UOnlineExternalUISubsystemShowLoginUI::HandleCallback_OnLoginUIClosed);

    if (!Handle->ShowLoginUI(
            this->__Store__ControllerIndex,
            this->__Store__bShowOnlineOnly,
            this->__Store__bShowSkipButton,
            __DelegateHandle_OnLoginUIClosed))
    {
...
void UOnlineExternalUISubsystemShowLoginUI::HandleCallback_OnLoginUIClosed(
...
UOnlineExternalUISubsystemShowAccountCreationUI *UOnlineExternalUISubsystemShowAccountCreationUI::ShowAccountCreationUI(
    UOnlineExternalUISubsystem *Subsystem,
    int ControllerIndex)
{
    if (!IsValid(Subsystem))
    ...
    UOnlineExternalUISubsystemShowAccountCreationUI *Node =
        NewObject<UOnlineExternalUISubsystemShowAccountCreationUI>();
    Node->__Store__Subsystem = Subsystem;
    Node->__Store__CallUniquenessId = TEXT("");
    Node->__Store__ControllerIndex = ControllerIndex;
    return Node;
...
void UOnlineExternalUISubsystemShowAccountCreationUI::Activate()
{
    ...
    auto __DelegateHandle_OnAccountCreationUIClosed = FOnAccountCreationUIClosedDelegate::CreateUObject(
        this,
        &UOnlineExternalUISubsystemShowAccountCreationUI::HandleCallback_OnAccountCreationUIClosed);
...
void UOnlineExternalUISubsystemShowAccountCreationUI::HandleCallback_OnAccountCreationUIClosed(
    const int ControllerIndex,
    ...
    const FOnlineError &Error)
{
    ...
    this->OnAccountCreationUIClosed.Broadcast(
        ControllerIndex,
        FOnlineAccountCredential::FromNative(AccountCredentials),
...
bool UOnlineExternalUISubsystem::ShowLeaderboardUI(const FString &LeaderboardName)
{
    check(!this->HasAnyFlags(RF_ClassDefaultObject));
    auto Handle = this->GetHandle();
    if (!this->IsHandleValid(Handle))
...
UOnlineExternalUISubsystemShowWebURL *UOnlineExternalUISubsystemShowWebURL::ShowWebURL(
    UOnlineExternalUISubsystem *Subsystem,
    const FString &Url,
    const FShowWebUrlParameters &ShowParams)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
...
void UOnlineExternalUISubsystemShowWebURL::Activate()
{
    ...
    auto __DelegateHandle_OnShowWebUrlClosed = FOnShowWebUrlClosedDelegate::CreateUObject(
        this,
        &UOnlineExternalUISubsystemShowWebURL::HandleCallback_OnShowWebUrlClosed);

    if (!Handle->ShowWebURL(
            this->__Store__Url,
            this->__Store__ShowParams.ToNative(),
            __DelegateHandle_OnShowWebUrlClosed))
    {
...
UOnlineExternalUISubsystemShowProfileUI *UOnlineExternalUISubsystemShowProfileUI::ShowProfileUI(
    UOnlineExternalUISubsystem *Subsystem,
    const FUniqueNetIdRepl &Requestor,
    const FUniqueNetIdRepl &Requestee)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
...
void UOnlineExternalUISubsystemShowProfileUI::Activate()
{
    ...
    if (!(this->__Store__Requestor.IsValid() && this->__Store__Requestor.GetUniqueNetId().IsValid()))
    {
        UE_LOG(LogOnlineBlueprint, Error, TEXT("Parameter 'Requestor' was not valid"));
        this->OnCallFailed.Broadcast();
        return;
    }
    if (!(this->__Store__Requestee.IsValid() && this->__Store__Requestee.GetUniqueNetId().IsValid()))
    {
    ...
    auto __DelegateHandle_OnProfileUIClosed = FOnProfileUIClosedDelegate::CreateUObject(
        this,
        &UOnlineExternalUISubsystemShowProfileUI::HandleCallback_OnProfileUIClosed);

    if (!Handle->ShowProfileUI(
            this->__Store__Requestor.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__Requestee.GetUniqueNetId().ToSharedRef().Get(),
            __DelegateHandle_OnProfileUIClosed))
    {
...
bool UOnlineExternalUISubsystem::ShowAccountUpgradeUI(const FUniqueNetIdRepl &UniqueId)
{
    check(!this->HasAnyFlags(RF_ClassDefaultObject));
    auto Handle = this->GetHandle();
    if (!this->IsHandleValid(Handle))
...
UOnlineExternalUISubsystemShowStoreUI *UOnlineExternalUISubsystemShowStoreUI::ShowStoreUI(
    UOnlineExternalUISubsystem *Subsystem,
    int32 LocalUserNum,
    const FShowStoreParameters &ShowParams)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
...
void UOnlineExternalUISubsystemShowStoreUI::Activate()
{
    ...
    auto __DelegateHandle_OnShowStoreUIClosed = FOnShowStoreUIClosedDelegate::CreateUObject(
        this,
        &UOnlineExternalUISubsystemShowStoreUI::HandleCallback_OnShowStoreUIClosed);

    if (!Handle->ShowStoreUI(
            this->__Store__LocalUserNum,
            this->__Store__ShowParams.ToNative(),
            __DelegateHandle_OnShowStoreUIClosed))
    {
...
UOnlineExternalUISubsystemShowSendMessageUI *UOnlineExternalUISubsystemShowSendMessageUI::ShowSendMessageUI(
    UOnlineExternalUISubsystem *Subsystem,
    int32 LocalUserNum,
    const FShowSendMessageParameters &ShowParams)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
...
void UOnlineExternalUISubsystemShowSendMessageUI::Activate()
{
    ...
    auto __DelegateHandle_OnShowSendMessageUIClosed = FOnShowSendMessageUIClosedDelegate::CreateUObject(
        this,
        &UOnlineExternalUISubsystemShowSendMessageUI::HandleCallback_OnShowSendMessageUIClosed);

    if (!Handle->ShowSendMessageUI(
            this->__Store__LocalUserNum,
            this->__Store__ShowParams.ToNative(),
            __DelegateHandle_OnShowSendMessageUIClosed))
    {
        ...
        const FShowSendMessageParameters &ShowParams)
{
    ...
    UOnlineExternalUISubsystemShowSendMessageToUserUI *Node =
        NewObject<UOnlineExternalUISubsystemShowSendMessageToUserUI>();
    Node->__Store__Subsystem = Subsystem;
    Node->__Store__CallUniquenessId = TEXT("");
    Node->__Store__LocalUserNum = LocalUserNum;
...
void UOnlineExternalUISubsystemShowSendMessageToUserUI::Activate()
{
    ...
    auto __DelegateHandle_OnShowSendMessageUIClosed = FOnShowSendMessageUIClosedDelegate::CreateUObject(
        this,
        &UOnlineExternalUISubsystemShowSendMessageToUserUI::HandleCallback_OnShowSendMessageUIClosed);

    if (!Handle->ShowSendMessageToUserUI(
            this->__Store__LocalUserNum,
            this->__Store__Recipient.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__ShowParams.ToNative(),
            __DelegateHandle_OnShowSendMessageUIClosed))
    {
...
bool UOnlineExternalUISubsystem::ShowPlatformMessageBox(
    ...
    EPlatformMessageType_ MessageType)
{
    ...
    auto __Result = Handle->ShowPlatformMessageBox(
