...
UOnlineSharingSubsystem::UOnlineSharingSubsystem()
{
    ...
    UE_LOG(
        LogOnlineBlueprint,
        Verbose,
        TEXT("OnlineSharingSubsystem subsystem initialized in context %s"),
    ...
    if (Handle.IsValid())
    {
        ...
        {
            this->DelegateHandle_OnRequestNewReadPermissionsComplete.Add(
                Handle->AddOnRequestNewReadPermissionsCompleteDelegate_Handle(
                    i,
                    FOnRequestNewReadPermissionsComplete::FDelegate::CreateWeakLambda(
                        this,
                        [this, i](int32 _UnusedLocalUserNum, bool Param1) {
                            this->OnRequestNewReadPermissionsComplete.Broadcast(i, Param1);
                        })));
            this->DelegateHandle_OnRequestNewPublishPermissionsComplete.Add(
                Handle->AddOnRequestNewPublishPermissionsCompleteDelegate_Handle(
                    i,
                    FOnRequestNewPublishPermissionsComplete::FDelegate::CreateWeakLambda(
                        this,
                        [this, i](int32 _UnusedLocalUserNum, bool Param1) {
            ...
            this->DelegateHandle_OnReadNewsFeedComplete.Add(Handle->AddOnReadNewsFeedCompleteDelegate_Handle(
                i,
                FOnReadNewsFeedComplete::FDelegate::CreateWeakLambda(
                    this,
                    [this, i](int32 _UnusedLocalUserNum, bool Param1) {
            ...
            this->DelegateHandle_OnSharePostComplete.Add(Handle->AddOnSharePostCompleteDelegate_Handle(
                i,
                FOnSharePostComplete::FDelegate::CreateWeakLambda(
                    this,
                    [this, i](int32 _UnusedLocalUserNum, bool Param1) {
...
void UOnlineSharingSubsystem::BeginDestroy()
{
    ...
    if (Handle.IsValid())
    {
        for (auto i = 0; i < MAX_LOCAL_PLAYERS; i++)
        {
            Handle->ClearOnRequestNewReadPermissionsCompleteDelegate_Handle(
                i,
                this->DelegateHandle_OnRequestNewReadPermissionsComplete[i]);
            Handle->ClearOnRequestNewPublishPermissionsCompleteDelegate_Handle(
                i,
                this->DelegateHandle_OnRequestNewPublishPermissionsComplete[i]);
