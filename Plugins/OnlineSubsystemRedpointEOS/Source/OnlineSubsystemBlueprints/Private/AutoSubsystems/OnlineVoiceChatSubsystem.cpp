...
void UOnlineVoiceChatSubsystem::RegisterFunctionDelegates()
{
    ...
    {
        this->FunctionDelegateHandle_FOnVoiceChatReconnectedDelegate =
            Handle->OnVoiceChatReconnected().AddLambda([this]() {
        ...
        this->FunctionDelegateHandle_FOnVoiceChatDisconnectedDelegate =
            Handle->OnVoiceChatDisconnected().AddLambda([this](const FVoiceChatResult &Reason) {
...
UOnlineVoiceChatSubsystemConnect *UOnlineVoiceChatSubsystemConnect::Connect(UOnlineVoiceChatSubsystem *Subsystem)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
            LogOnlineBlueprint,
            Error,
            TEXT("OnlineVoiceChatSubsystem is not available. It's possible the online subsystem you are using doesn't "
...
void UOnlineVoiceChatSubsystemConnect::Activate()
{
    ...
    auto __DelegateHandle_OnVoiceChatConnectComplete = FOnVoiceChatConnectCompleteDelegate::CreateUObject(
        this,
        &UOnlineVoiceChatSubsystemConnect::HandleCallback_OnVoiceChatConnectComplete);
...
UOnlineVoiceChatSubsystemDisconnect *UOnlineVoiceChatSubsystemDisconnect::Disconnect(
...
void UOnlineVoiceChatSubsystemDisconnect::Activate()
{
    ...
    auto __DelegateHandle_OnVoiceChatDisconnectComplete = FOnVoiceChatDisconnectCompleteDelegate::CreateUObject(
        this,
        &UOnlineVoiceChatSubsystemDisconnect::HandleCallback_OnVoiceChatDisconnectComplete);
