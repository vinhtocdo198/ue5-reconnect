...
FName UOnlineEventsSubsystem::OSSNameToAssignDuringConstruction = NAME_Default;
...
UOnlineEventsSubsystem::UOnlineEventsSubsystem()
{
    ...
    this->OSSName = UOnlineEventsSubsystem::OSSNameToAssignDuringConstruction;
    ...
    UE_LOG(
        LogOnlineBlueprint,
        Verbose,
        TEXT("OnlineEventsSubsystem subsystem initialized in context %s"),
