...
FName UOnlineMessageSanitizerSubsystem::OSSNameToAssignDuringConstruction = NAME_Default;
...
bool UOnlineMessageSanitizerSubsystem::IsHandleValid(
    const TSharedPtr<class IMessageSanitizer, ESPMode::ThreadSafe> &InHandle)
{
...
UOnlineMessageSanitizerSubsystem::UOnlineMessageSanitizerSubsystem()
{
    ...
    this->OSSName = UOnlineMessageSanitizerSubsystem::OSSNameToAssignDuringConstruction;
    ...
    UE_LOG(
        LogOnlineBlueprint,
        Verbose,
        TEXT("OnlineMessageSanitizerSubsystem subsystem initialized in context %s"),
...
UOnlineMessageSanitizerSubsystemSanitizeDisplayName *UOnlineMessageSanitizerSubsystemSanitizeDisplayName::
    SanitizeDisplayName(UOnlineMessageSanitizerSubsystem *Subsystem, const FString &DisplayName)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
            ...
            Error,
            TEXT(
                "OnlineMessageSanitizerSubsystem is not available. It's possible the online subsystem you are using "
    ...
    UOnlineMessageSanitizerSubsystemSanitizeDisplayName *Node =
        NewObject<UOnlineMessageSanitizerSubsystemSanitizeDisplayName>();
...
void UOnlineMessageSanitizerSubsystemSanitizeDisplayName::Activate()
{
    ...
    auto __DelegateHandle_OnMessageProcessed = FOnMessageProcessed::CreateUObject(
        this,
        &UOnlineMessageSanitizerSubsystemSanitizeDisplayName::HandleCallback_OnMessageProcessed);

    Handle->SanitizeDisplayName(this->__Store__DisplayName, __DelegateHandle_OnMessageProcessed);
}

void UOnlineMessageSanitizerSubsystemSanitizeDisplayName::HandleCallback_OnMessageProcessed(
    bool bSuccess,
...
UOnlineMessageSanitizerSubsystemSanitizeDisplayNames *UOnlineMessageSanitizerSubsystemSanitizeDisplayNames::
    SanitizeDisplayNames(UOnlineMessageSanitizerSubsystem *Subsystem, const TArray<FString> &DisplayNames)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
    ...
    UOnlineMessageSanitizerSubsystemSanitizeDisplayNames *Node =
        NewObject<UOnlineMessageSanitizerSubsystemSanitizeDisplayNames>();
    Node->__Store__Subsystem = Subsystem;
    Node->__Store__CallUniquenessId = TEXT("");
...
void UOnlineMessageSanitizerSubsystemSanitizeDisplayNames::Activate()
{
    ...
    if (!(ValidateArrayElements<FString>(this->__Store__DisplayNames, [](const FString &Val) {
            return true;
        })))
    {
    ...
    auto __DelegateHandle_OnMessageArrayProcessed = FOnMessageArrayProcessed::CreateUObject(
        this,
        &UOnlineMessageSanitizerSubsystemSanitizeDisplayNames::HandleCallback_OnMessageArrayProcessed);

    Handle->SanitizeDisplayNames(
        ConvertArrayElements<FString, FString>(
            this->__Store__DisplayNames,
            [](const FString &Val) {
                return Val;
            }),
        __DelegateHandle_OnMessageArrayProcessed);
}

void UOnlineMessageSanitizerSubsystemSanitizeDisplayNames::HandleCallback_OnMessageArrayProcessed(
    bool bSuccess,
    const TArray<FString> &SanitizedMessages)
{
    ...
    this->OnMessageArrayProcessed.Broadcast(
        bSuccess,
        ConvertArrayElements<FString, FString>(SanitizedMessages, [](const FString &Val) {
            return Val;
        }));
}

UOnlineMessageSanitizerSubsystemQueryBlockedUser *UOnlineMessageSanitizerSubsystemQueryBlockedUser::QueryBlockedUser(
    ...
    const FString &FromPlatform)
{
    ...
    UOnlineMessageSanitizerSubsystemQueryBlockedUser *Node =
        NewObject<UOnlineMessageSanitizerSubsystemQueryBlockedUser>();
    Node->__Store__Subsystem = Subsystem;
    Node->__Store__CallUniquenessId = TEXT("");
...
void UOnlineMessageSanitizerSubsystemQueryBlockedUser::Activate()
{
    ...
    auto __DelegateHandle_OnQueryUserBlockedResponse = FOnQueryUserBlockedResponse::CreateUObject(
        this,
        &UOnlineMessageSanitizerSubsystemQueryBlockedUser::HandleCallback_OnQueryUserBlockedResponse);

    Handle->QueryBlockedUser(
        this->__Store__LocalUserNum,
        this->__Store__FromUserId,
        this->__Store__FromPlatform,
        __DelegateHandle_OnQueryUserBlockedResponse);
}

void UOnlineMessageSanitizerSubsystemQueryBlockedUser::HandleCallback_OnQueryUserBlockedResponse(
    const FBlockedQueryResult &QueryResult)
{
    if (!IsValid(this->__Store__Subsystem))
    {
        UE_LOG(LogOnlineBlueprint, Error, TEXT("Subsystem was not valid during callback handling"));
