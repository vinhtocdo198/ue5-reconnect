...
FName UOnlineTurnBasedSubsystem::OSSNameToAssignDuringConstruction = NAME_Default;
...
UOnlineTurnBasedSubsystem::UOnlineTurnBasedSubsystem()
{
    ...
    this->OSSName = UOnlineTurnBasedSubsystem::OSSNameToAssignDuringConstruction;
    ...
    UE_LOG(
        LogOnlineBlueprint,
        Verbose,
        TEXT("OnlineTurnBasedSubsystem subsystem initialized in context %s"),
...
UOnlineTurnBasedSubsystemLoadAllMatches *UOnlineTurnBasedSubsystemLoadAllMatches::LoadAllMatches(
    UOnlineTurnBasedSubsystem *Subsystem)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
            LogOnlineBlueprint,
            Error,
            TEXT("OnlineTurnBasedSubsystem is not available. It's possible the online subsystem you are using doesn't "
...
void UOnlineTurnBasedSubsystemLoadAllMatches::Activate()
{
    ...
    auto __DelegateHandle_LoadTurnBasedMatchesSignature = FLoadTurnBasedMatchesSignature::CreateUObject(
        this,
        &UOnlineTurnBasedSubsystemLoadAllMatches::HandleCallback_LoadTurnBasedMatchesSignature);

    Handle->LoadAllMatches(__DelegateHandle_LoadTurnBasedMatchesSignature);
}

void UOnlineTurnBasedSubsystemLoadAllMatches::HandleCallback_LoadTurnBasedMatchesSignature(
    ...
    bool Param2)
{
    ...
    this->LoadTurnBasedMatchesSignature.Broadcast(
...
UOnlineTurnBasedSubsystemLoadMatchWithID *UOnlineTurnBasedSubsystemLoadMatchWithID::LoadMatchWithID(
    UOnlineTurnBasedSubsystem *Subsystem,
...
void UOnlineTurnBasedSubsystemLoadMatchWithID::Activate()
{
    ...
    auto __DelegateHandle_LoadTurnBasedMatchWithIDSignature = FLoadTurnBasedMatchWithIDSignature::CreateUObject(
        this,
        &UOnlineTurnBasedSubsystemLoadMatchWithID::HandleCallback_LoadTurnBasedMatchWithIDSignature);

    Handle->LoadMatchWithID(this->__Store__MatchID, __DelegateHandle_LoadTurnBasedMatchWithIDSignature);
}

void UOnlineTurnBasedSubsystemLoadMatchWithID::HandleCallback_LoadTurnBasedMatchWithIDSignature(
    FString Param1,
    bool Param2)
{
    if (!IsValid(this->__Store__Subsystem))
