...
FName UOnlineGameItemStatsSubsystem::OSSNameToAssignDuringConstruction = NAME_Default;
...
bool UOnlineGameItemStatsSubsystem::IsHandleValid(
    const TSharedPtr<class IOnlineGameItemStats, ESPMode::ThreadSafe> &InHandle)
{
...
UOnlineGameItemStatsSubsystem::UOnlineGameItemStatsSubsystem()
{
    ...
    this->OSSName = UOnlineGameItemStatsSubsystem::OSSNameToAssignDuringConstruction;
    ...
    UE_LOG(
        LogOnlineBlueprint,
        Verbose,
        TEXT("OnlineGameItemStatsSubsystem subsystem initialized in context %s"),
...
UOnlineGameItemStatsSubsystemItemUsage *UOnlineGameItemStatsSubsystemItemUsage::ItemUsage(
    ...
    const TArray<FString> &ItemsUsed)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
            ...
            Error,
            TEXT(
                "OnlineGameItemStatsSubsystem is not available. It's possible the online subsystem you are using "
                "doesn't support it. Alternatively, make sure that you are not attempting to use Online Subsystem "
                "Blueprints during the Init event in a GameInstance. Add a 'Delay 0.1' node between the Init event and "
                "the rest of your logic if you need to use Online Subsystem Blueprints this early in game startup."));
        return nullptr;
    }
...
void UOnlineGameItemStatsSubsystemItemUsage::Activate()
{
    ...
    if (!(ValidateArrayElements<FString>(this->__Store__ItemsUsed, [](const FString &Val) {
            return true;
        })))
    {
    ...
    auto __DelegateHandle_OnItemUsageComplete = FOnItemUsageComplete::CreateUObject(
        this,
        &UOnlineGameItemStatsSubsystemItemUsage::HandleCallback_OnItemUsageComplete);

    Handle->ItemUsage(
        this->__Store__LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
        this->__Store__ItemUsedBy,
        ConvertArrayElements<FString, FString>(
            this->__Store__ItemsUsed,
            [](const FString &Val) {
                return Val;
            }),
        __DelegateHandle_OnItemUsageComplete);
}

void UOnlineGameItemStatsSubsystemItemUsage::HandleCallback_OnItemUsageComplete(
    const FUniqueNetId &LocalUserId,
    const FOnlineError &Status)
{
    ...
    this->OnItemUsageComplete.Broadcast(
        ConvertDangerousUniqueNetIdToRepl(LocalUserId),
        FOnlineErrorInfo::FromNative(Status));
}

UOnlineGameItemStatsSubsystemItemImpact *UOnlineGameItemStatsSubsystemItemImpact::ItemImpact(
    UOnlineGameItemStatsSubsystem *Subsystem,
    const FUniqueNetIdRepl &LocalUserId,
...
void UOnlineGameItemStatsSubsystemItemImpact::Activate()
{
    ...
    if (!(ValidateArrayElements<FString>(this->__Store__TargetActors, [](const FString &Val) {
            return true;
        })))
    {
    ...
    auto __DelegateHandle_OnItemImpactComplete = FOnItemImpactComplete::CreateUObject(
        this,
        &UOnlineGameItemStatsSubsystemItemImpact::HandleCallback_OnItemImpactComplete);

    Handle->ItemImpact(
        this->__Store__LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
        ConvertArrayElements<FString, FString>(
            this->__Store__TargetActors,
            [](const FString &Val) {
                return Val;
            }),
        this->__Store__ImpactInitiatedBy,
        ConvertArrayElements<FString, FString>(
            this->__Store__ItemsUsed,
            [](const FString &Val) {
                return Val;
            }),
        __DelegateHandle_OnItemImpactComplete);
}

void UOnlineGameItemStatsSubsystemItemImpact::HandleCallback_OnItemImpactComplete(
    const FUniqueNetId &LocalUserId,
    const FOnlineError &Status)
{
    if (!IsValid(this->__Store__Subsystem))
    ...
    this->OnItemImpactComplete.Broadcast(
        ConvertDangerousUniqueNetIdToRepl(LocalUserId),
        FOnlineErrorInfo::FromNative(Status));
}

UOnlineGameItemStatsSubsystemItemMitigation *UOnlineGameItemStatsSubsystemItemMitigation::ItemMitigation(
    UOnlineGameItemStatsSubsystem *Subsystem,
    const FUniqueNetIdRepl &LocalUserId,
    const TArray<FString> &ItemsUsed,
...
void UOnlineGameItemStatsSubsystemItemMitigation::Activate()
{
    ...
    if (!(ValidateArrayElements<FString>(this->__Store__ImpactItemsMitigated, [](const FString &Val) {
            return true;
        })))
    {
    ...
    auto __DelegateHandle_OnItemMitigationComplete = FOnItemMitigationComplete::CreateUObject(
        this,
        &UOnlineGameItemStatsSubsystemItemMitigation::HandleCallback_OnItemMitigationComplete);
    ...
    Handle->ItemMitigation(
        ...
        ConvertArrayElements<FString, FString>(
            this->__Store__ImpactItemsMitigated,
            [](const FString &Val) {
                return Val;
            }),
        this->__Store__ItemUsedBy,
        __DelegateHandle_OnItemMitigationComplete);
}

void UOnlineGameItemStatsSubsystemItemMitigation::HandleCallback_OnItemMitigationComplete(
    const FUniqueNetId &LocalUserId,
    const FOnlineError &Status)
{
    if (!IsValid(this->__Store__Subsystem))
        ...
        const TArray<FString> &UnavailableItems)
{
    ...
    UOnlineGameItemStatsSubsystemItemAvailabilityChange *Node =
        NewObject<UOnlineGameItemStatsSubsystemItemAvailabilityChange>();
    Node->__Store__Subsystem = Subsystem;
    Node->__Store__CallUniquenessId = TEXT("");
    Node->__Store__LocalUserId = LocalUserId;
...
void UOnlineGameItemStatsSubsystemItemAvailabilityChange::Activate()
{
    ...
    if (!(ValidateArrayElements<FString>(this->__Store__AvailableItems, [](const FString &Val) {
            return true;
        })))
    {
    ...
    if (!(ValidateArrayElements<FString>(this->__Store__UnavailableItems, [](const FString &Val) {
            return true;
        })))
    {
    ...
    auto __DelegateHandle_OnItemAvailabilityChangeComplete = FOnItemAvailabilityChangeComplete::CreateUObject(
        this,
        &UOnlineGameItemStatsSubsystemItemAvailabilityChange::HandleCallback_OnItemAvailabilityChangeComplete);

    Handle->ItemAvailabilityChange(
        this->__Store__LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
        ConvertArrayElements<FString, FString>(
            this->__Store__AvailableItems,
            [](const FString &Val) {
                return Val;
            }),
        ConvertArrayElements<FString, FString>(
            this->__Store__UnavailableItems,
            [](const FString &Val) {
                return Val;
            }),
        __DelegateHandle_OnItemAvailabilityChangeComplete);
}

void UOnlineGameItemStatsSubsystemItemAvailabilityChange::HandleCallback_OnItemAvailabilityChangeComplete(
    const FUniqueNetId &LocalUserId,
    const FOnlineError &Status)
{
    if (!IsValid(this->__Store__Subsystem))
    ...
    this->OnItemAvailabilityChangeComplete.Broadcast(
        ConvertDangerousUniqueNetIdToRepl(LocalUserId),
        FOnlineErrorInfo::FromNative(Status));
}

UOnlineGameItemStatsSubsystemItemInventoryChange *UOnlineGameItemStatsSubsystemItemInventoryChange::ItemInventoryChange(
    UOnlineGameItemStatsSubsystem *Subsystem,
    const FUniqueNetIdRepl &LocalUserId,
    ...
    const TArray<FString> &ItemsToRemove)
{
    ...
    UOnlineGameItemStatsSubsystemItemInventoryChange *Node =
        NewObject<UOnlineGameItemStatsSubsystemItemInventoryChange>();
    Node->__Store__Subsystem = Subsystem;
    Node->__Store__CallUniquenessId = TEXT("");
    Node->__Store__LocalUserId = LocalUserId;
...
void UOnlineGameItemStatsSubsystemItemInventoryChange::Activate()
{
    ...
    if (!(ValidateArrayElements<FString>(this->__Store__ItemsToAdd, [](const FString &Val) {
            return true;
        })))
    {
    ...
    if (!(ValidateArrayElements<FString>(this->__Store__ItemsToRemove, [](const FString &Val) {
            return true;
        })))
    {
    ...
    auto __DelegateHandle_OnItemInventoryChangeComplete = FOnItemInventoryChangeComplete::CreateUObject(
        this,
        &UOnlineGameItemStatsSubsystemItemInventoryChange::HandleCallback_OnItemInventoryChangeComplete);

    Handle->ItemInventoryChange(
        this->__Store__LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
        ConvertArrayElements<FString, FString>(
            this->__Store__ItemsToAdd,
            [](const FString &Val) {
                return Val;
            }),
        ConvertArrayElements<FString, FString>(
            this->__Store__ItemsToRemove,
            [](const FString &Val) {
                return Val;
            }),
        __DelegateHandle_OnItemInventoryChangeComplete);
}

void UOnlineGameItemStatsSubsystemItemInventoryChange::HandleCallback_OnItemInventoryChangeComplete(
    const FUniqueNetId &LocalUserId,
    const FOnlineError &Status)
{
    if (!IsValid(this->__Store__Subsystem))
    ...
    this->OnItemInventoryChangeComplete.Broadcast(
        ConvertDangerousUniqueNetIdToRepl(LocalUserId),
        FOnlineErrorInfo::FromNative(Status));
}

UOnlineGameItemStatsSubsystemItemLoadoutChange *UOnlineGameItemStatsSubsystemItemLoadoutChange::ItemLoadoutChange(
    UOnlineGameItemStatsSubsystem *Subsystem,
    const FUniqueNetIdRepl &LocalUserId,
...
void UOnlineGameItemStatsSubsystemItemLoadoutChange::Activate()
{
    ...
    if (!(ValidateArrayElements<FString>(this->__Store__EquippedItems, [](const FString &Val) {
            return true;
        })))
    {
    ...
    if (!(ValidateArrayElements<FString>(this->__Store__UnequippedItems, [](const FString &Val) {
            return true;
        })))
    {
    ...
    auto __DelegateHandle_OnItemLoadoutChangeComplete = FOnItemLoadoutChangeComplete::CreateUObject(
        this,
        &UOnlineGameItemStatsSubsystemItemLoadoutChange::HandleCallback_OnItemLoadoutChangeComplete);

    Handle->ItemLoadoutChange(
        this->__Store__LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
        ConvertArrayElements<FString, FString>(
            this->__Store__EquippedItems,
            [](const FString &Val) {
                return Val;
            }),
        ConvertArrayElements<FString, FString>(
            this->__Store__UnequippedItems,
            [](const FString &Val) {
                return Val;
            }),
        __DelegateHandle_OnItemLoadoutChangeComplete);
}

void UOnlineGameItemStatsSubsystemItemLoadoutChange::HandleCallback_OnItemLoadoutChangeComplete(
    const FUniqueNetId &LocalUserId,
    const FOnlineError &Status)
{
    if (!IsValid(this->__Store__Subsystem))
    ...
    this->OnItemLoadoutChangeComplete.Broadcast(
        ConvertDangerousUniqueNetIdToRepl(LocalUserId),
        FOnlineErrorInfo::FromNative(Status));
}
