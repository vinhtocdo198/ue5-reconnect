...
FName UOnlineAvatarSubsystem::OSSNameToAssignDuringConstruction = NAME_Default;
...
UOnlineAvatarSubsystem::UOnlineAvatarSubsystem()
{
    ...
    this->OSSName = UOnlineAvatarSubsystem::OSSNameToAssignDuringConstruction;
    ...
    UE_LOG(
        LogOnlineBlueprint,
        Verbose,
        TEXT("OnlineAvatarSubsystem subsystem initialized in context %s"),
...
UOnlineAvatarSubsystemGetAvatar *UOnlineAvatarSubsystemGetAvatar::GetAvatar(
    ...
    UTexture *DefaultTexture)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
            LogOnlineBlueprint,
            Error,
            TEXT("OnlineAvatarSubsystem is not available. It's possible the online subsystem you are using doesn't "
...
void UOnlineAvatarSubsystemGetAvatar::Activate()
{
    ...
    auto __DelegateHandle_OnGetAvatarComplete =
        FOnGetAvatarComplete::CreateUObject(this, &UOnlineAvatarSubsystemGetAvatar::HandleCallback_OnGetAvatarComplete);

    if (!Handle->GetAvatar(
            this->__Store__LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__TargetUserId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__DefaultTexture,
            __DelegateHandle_OnGetAvatarComplete))
    {
...
void UOnlineAvatarSubsystemGetAvatar::HandleCallback_OnGetAvatarComplete(
    bool bWasSuccessful,
...
UOnlineAvatarSubsystemGetAvatarUrl *UOnlineAvatarSubsystemGetAvatarUrl::GetAvatarUrl(
    UOnlineAvatarSubsystem *Subsystem,
    const FUniqueNetIdRepl &LocalUserId,
    const FUniqueNetIdRepl &TargetUserId,
...
void UOnlineAvatarSubsystemGetAvatarUrl::Activate()
{
    ...
    auto __DelegateHandle_OnGetAvatarUrlComplete = FOnGetAvatarUrlComplete::CreateUObject(
        this,
        &UOnlineAvatarSubsystemGetAvatarUrl::HandleCallback_OnGetAvatarUrlComplete);

    if (!Handle->GetAvatarUrl(
            this->__Store__LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__TargetUserId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__DefaultAvatarUrl,
            __DelegateHandle_OnGetAvatarUrlComplete))
    {
...
void UOnlineAvatarSubsystemGetAvatarUrl::HandleCallback_OnGetAvatarUrlComplete(
    bool bWasSuccessful,
