...
FName UOnlineSessionSubsystem::OSSNameToAssignDuringConstruction = NAME_Default;
...
UOnlineSessionSubsystem::UOnlineSessionSubsystem()
{
    ...
    this->OSSName = UOnlineSessionSubsystem::OSSNameToAssignDuringConstruction;
    ...
    UE_LOG(
        LogOnlineBlueprint,
        Verbose,
        TEXT("OnlineSessionSubsystem subsystem initialized in context %s"),
    ...
    if (Handle.IsValid())
    {
        for (auto i = 0; i < MAX_LOCAL_PLAYERS; i++)
        {
            this->DelegateHandle_OnFindFriendSessionComplete.Add(Handle->AddOnFindFriendSessionCompleteDelegate_Handle(
                i,
                FOnFindFriendSessionComplete::FDelegate::CreateWeakLambda(
                    this,
                    [this,
                     i](int32 _UnusedLocalUserNum,
                        bool bWasSuccessful,
                        const TArray<FOnlineSessionSearchResult> &FriendSearchResult) {
                        this->OnFindFriendSessionComplete.Broadcast(
                            i,
                            bWasSuccessful,
                            ConvertArrayElements<FOnlineSessionSearchResult, FOnlineSessionSearchResultBP>(
                                FriendSearchResult,
                                [](const FOnlineSessionSearchResult &Val) {
                                    return FOnlineSessionSearchResultBP::FromNative(Val);
                                }));
                    })));
        }
        ...
        this->DelegateHandle_OnDestroySessionComplete =
            Handle->AddOnDestroySessionCompleteDelegate_Handle(FOnDestroySessionComplete::FDelegate::CreateWeakLambda(
                this,
        ...
        this->DelegateHandle_OnCancelMatchmakingComplete = Handle->AddOnCancelMatchmakingCompleteDelegate_Handle(
            FOnCancelMatchmakingComplete::FDelegate::CreateWeakLambda(
                this,
                [this](FName SessionName, bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnJoinSessionComplete =
            Handle->AddOnJoinSessionCompleteDelegate_Handle(FOnJoinSessionComplete::FDelegate::CreateWeakLambda(
                this,
        ...
        this->DelegateHandle_OnSessionParticipantJoined = Handle->AddOnSessionParticipantJoinedDelegate_Handle(
            FOnSessionParticipantJoined::FDelegate::CreateWeakLambda(
                this,
                [this](FName Param1, const FUniqueNetId &Param2) {
                    this->OnSessionParticipantJoined.Broadcast(Param1, ConvertDangerousUniqueNetIdToRepl(Param2));
                }));
        this->DelegateHandle_OnSessionParticipantLeft =
            Handle->AddOnSessionParticipantLeftDelegate_Handle(FOnSessionParticipantLeft::FDelegate::CreateWeakLambda(
                this,
                [this](FName Param1, const FUniqueNetId &Param2, EOnSessionParticipantLeftReason Param3) {
                    this->OnSessionParticipantLeft.Broadcast(
                        Param1,
                        ConvertDangerousUniqueNetIdToRepl(Param2),
                        (EOnSessionParticipantLeftReason_)(Param3));
                }));
        ...
        this->DelegateHandle_OnSessionSettingsUpdated =
            Handle->AddOnSessionSettingsUpdatedDelegate_Handle(FOnSessionSettingsUpdated::FDelegate::CreateWeakLambda(
                this,
                [this](FName Param1, const FOnlineSessionSettings &Param2) {
                    this->OnSessionSettingsUpdated.Broadcast(Param1, FOnlineSessionSettingsBP::FromNative(Param2));
                }));
        this->DelegateHandle_OnSessionParticipantSettingsUpdated =
            Handle->AddOnSessionParticipantSettingsUpdatedDelegate_Handle(
                FOnSessionParticipantSettingsUpdated::FDelegate::CreateWeakLambda(
                    this,
                    [this](FName Param1, const FUniqueNetId &Param2, const FOnlineSessionSettings &Param3) {
                        this->OnSessionParticipantSettingsUpdated.Broadcast(
                            Param1,
                            ConvertDangerousUniqueNetIdToRepl(Param2),
                            FOnlineSessionSettingsBP::FromNative(Param3));
                    }));
        this->DelegateHandle_OnSessionUserInviteAccepted = Handle->AddOnSessionUserInviteAcceptedDelegate_Handle(
            FOnSessionUserInviteAccepted::FDelegate::CreateWeakLambda(
                this,
                [this](
                    ...
                    this->OnSessionUserInviteAccepted.Broadcast(
                        bWasSuccessful,
                        ControllerId,
                        FUniqueNetIdRepl(UserId),
                        FOnlineSessionSearchResultBP::FromNative(InviteResult));
                }));
        this->DelegateHandle_OnSessionInviteReceived =
            Handle->AddOnSessionInviteReceivedDelegate_Handle(FOnSessionInviteReceived::FDelegate::CreateWeakLambda(
                this,
                [this](
                    ...
                    const FString &AppId,
                    const FOnlineSessionSearchResult &InviteResult) {
                    this->OnSessionInviteReceived.Broadcast(
                        ConvertDangerousUniqueNetIdToRepl(UserId),
                        ConvertDangerousUniqueNetIdToRepl(FromId),
                        AppId,
                        FOnlineSessionSearchResultBP::FromNative(InviteResult));
                }));
        this->DelegateHandle_OnRegisterPlayersComplete =
            Handle->AddOnRegisterPlayersCompleteDelegate_Handle(FOnRegisterPlayersComplete::FDelegate::CreateWeakLambda(
                this,
                [this](FName SessionName, const TArray<FUniqueNetIdRef> &PlayerIds, bool bWasSuccessful) {
                    this->OnRegisterPlayersComplete.Broadcast(
                        SessionName,
                        ConvertArrayElements<FUniqueNetIdRef, FUniqueNetIdRepl>(
                            PlayerIds,
        ...
        this->DelegateHandle_OnUnregisterPlayersComplete = Handle->AddOnUnregisterPlayersCompleteDelegate_Handle(
            FOnUnregisterPlayersComplete::FDelegate::CreateWeakLambda(
                this,
                [this](FName SessionName, const TArray<FUniqueNetIdRef> &PlayerIds, bool bWasSuccessful) {
                    this->OnUnregisterPlayersComplete.Broadcast(
                        SessionName,
                        ConvertArrayElements<FUniqueNetIdRef, FUniqueNetIdRepl>(
                            PlayerIds,
                            [](const FUniqueNetIdRef &Val) {
        ...
        this->DelegateHandle_OnSessionFailure =
            Handle->AddOnSessionFailureDelegate_Handle(FOnSessionFailure::FDelegate::CreateWeakLambda(
                this,
                [this](const FUniqueNetId &PlayerId, ESessionFailure::Type FailureType) {
                    this->OnSessionFailure.Broadcast(
                        ConvertDangerousUniqueNetIdToRepl(PlayerId),
                        (ESessionFailure_)(FailureType));
                }));
#if REDPOINT_EOS_UE_5_5_OR_LATER
        this->DelegateHandle_OnDestroySessionRequested =
            Handle->AddOnDestroySessionRequestedDelegate_Handle(FOnDestroySessionRequested::FDelegate::CreateWeakLambda(
                this,
                [this](int32 LocalUserNum, FName SessionName) {
                    this->OnDestroySessionRequested.Broadcast(LocalUserNum, SessionName);
                }));
#endif
    }
}
...
void UOnlineSessionSubsystem::BeginDestroy()
{
    ...
    if (Handle.IsValid())
    {
        for (auto i = 0; i < MAX_LOCAL_PLAYERS; i++)
        {
            Handle->ClearOnFindFriendSessionCompleteDelegate_Handle(
                i,
                this->DelegateHandle_OnFindFriendSessionComplete[i]);
        }
        ...
        Handle->ClearOnSessionParticipantJoinedDelegate_Handle(this->DelegateHandle_OnSessionParticipantJoined);
        Handle->ClearOnSessionParticipantLeftDelegate_Handle(this->DelegateHandle_OnSessionParticipantLeft);
        ...
        Handle->ClearOnSessionParticipantSettingsUpdatedDelegate_Handle(
            this->DelegateHandle_OnSessionParticipantSettingsUpdated);
...
#if REDPOINT_EOS_UE_5_5_OR_LATER
        Handle->ClearOnDestroySessionRequestedDelegate_Handle(this->DelegateHandle_OnDestroySessionRequested);
#endif
    }
...
FUniqueNetIdRepl UOnlineSessionSubsystem::CreateSessionIdFromString(const FString &SessionIdStr)
{
    check(!this->HasAnyFlags(RF_ClassDefaultObject));
...
UOnlineSessionSubsystemCreateSession *UOnlineSessionSubsystemCreateSession::CreateSession(
    UOnlineSessionSubsystem *Subsystem,
    const FUniqueNetIdRepl &HostingPlayerId,
    FName SessionName,
    const FOnlineSessionSettingsBP &NewSessionSettings)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
            LogOnlineBlueprint,
            Error,
            TEXT("OnlineSessionSubsystem is not available. It's possible the online subsystem you are using doesn't "
...
void UOnlineSessionSubsystemCreateSession::Activate()
{
    ...
    if (!(this->__Store__HostingPlayerId.IsValid() && this->__Store__HostingPlayerId.GetUniqueNetId().IsValid()))
    {
    ...
    this->DelegateHandle_OnCreateSessionComplete =
        Handle->AddOnCreateSessionCompleteDelegate_Handle(FOnCreateSessionCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemCreateSession::HandleCallback_OnCreateSessionComplete));

    if (!Handle->CreateSession(
            this->__Store__HostingPlayerId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__SessionName,
            this->__Store__NewSessionSettings.ToNative()))
    {
...
void UOnlineSessionSubsystemCreateSession::HandleCallback_OnCreateSessionComplete(
    FName SessionName,
    bool bWasSuccessful)
{
...
UOnlineSessionSubsystemStartSession *UOnlineSessionSubsystemStartSession::StartSession(
    UOnlineSessionSubsystem *Subsystem,
    FName SessionName)
{
    if (!IsValid(Subsystem))
...
void UOnlineSessionSubsystemStartSession::Activate()
{
    ...
    this->DelegateHandle_OnStartSessionComplete =
        Handle->AddOnStartSessionCompleteDelegate_Handle(FOnStartSessionCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemStartSession::HandleCallback_OnStartSessionComplete));
...
UOnlineSessionSubsystemUpdateSession *UOnlineSessionSubsystemUpdateSession::UpdateSession(
    UOnlineSessionSubsystem *Subsystem,
    FName SessionName,
    const FOnlineSessionSettingsBP &UpdatedSessionSettings,
...
void UOnlineSessionSubsystemUpdateSession::Activate()
{
    ...
    this->DelegateHandle_OnUpdateSessionComplete =
        Handle->AddOnUpdateSessionCompleteDelegate_Handle(FOnUpdateSessionCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemUpdateSession::HandleCallback_OnUpdateSessionComplete));

    if (!Handle->UpdateSession(
            this->__Store__SessionName,
            this->__Store__UpdatedSessionSettings.ToNativeRef(),
            this->__Store__bShouldRefreshOnlineData))
    {
...
void UOnlineSessionSubsystemUpdateSession::HandleCallback_OnUpdateSessionComplete(
    FName SessionName,
    bool bWasSuccessful)
{
    if (!IsValid(this->__Store__Subsystem))
...
UOnlineSessionSubsystemEndSession *UOnlineSessionSubsystemEndSession::EndSession(
    UOnlineSessionSubsystem *Subsystem,
    FName SessionName)
{
    if (!IsValid(Subsystem))
...
void UOnlineSessionSubsystemEndSession::Activate()
{
    ...
    this->DelegateHandle_OnEndSessionComplete =
        Handle->AddOnEndSessionCompleteDelegate_Handle(FOnEndSessionCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemEndSession::HandleCallback_OnEndSessionComplete));
...
UOnlineSessionSubsystemDestroySession *UOnlineSessionSubsystemDestroySession::DestroySession(
    UOnlineSessionSubsystem *Subsystem,
    FName SessionName)
{
    if (!IsValid(Subsystem))
...
void UOnlineSessionSubsystemDestroySession::Activate()
{
    ...
    auto __DelegateHandle_OnDestroySessionComplete = FOnDestroySessionComplete::FDelegate::CreateUObject(
        this,
        &UOnlineSessionSubsystemDestroySession::HandleCallback_OnDestroySessionComplete);
...
void UOnlineSessionSubsystemDestroySession::HandleCallback_OnDestroySessionComplete(
    FName SessionName,
    bool bWasSuccessful)
{
    if (!IsValid(this->__Store__Subsystem))
...
bool UOnlineSessionSubsystem::IsPlayerInSession(FName SessionName, const FUniqueNetIdRepl &UniqueId)
{
    check(!this->HasAnyFlags(RF_ClassDefaultObject));
    auto Handle = this->GetHandle();
    if (!this->IsHandleValid(Handle))
...
UOnlineSessionSubsystemStartMatchmaking *UOnlineSessionSubsystemStartMatchmaking::StartMatchmaking(
    UOnlineSessionSubsystem *Subsystem,
    const TArray<FUniqueNetIdRepl> &LocalPlayers,
    FName SessionName,
    const FOnlineSessionSettingsBP &NewSessionSettings,
...
void UOnlineSessionSubsystemStartMatchmaking::Activate()
{
    ...
    if (!(ValidateArrayElements<FUniqueNetIdRepl>(this->__Store__LocalPlayers, [](const FUniqueNetIdRepl &Val) {
    ...
    this->DelegateHandle_OnMatchmakingComplete =
        Handle->AddOnMatchmakingCompleteDelegate_Handle(FOnMatchmakingCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemStartMatchmaking::HandleCallback_OnMatchmakingComplete));

    if (!Handle->StartMatchmaking(
            ConvertArrayElements<FUniqueNetIdRepl, FUniqueNetIdRef>(
                this->__Store__LocalPlayers,
                [](const FUniqueNetIdRepl &Val) {
                    return Val.GetUniqueNetId().ToSharedRef();
                }),
            this->__Store__SessionName,
            this->__Store__NewSessionSettings.ToNative(),
            this->__Store__SearchSettings->ToNativeRef()))
    {
...
void UOnlineSessionSubsystemStartMatchmaking::HandleCallback_OnMatchmakingComplete(
    FName SessionName,
    bool bWasSuccessful)
{
    if (!IsValid(this->__Store__Subsystem))
...
UOnlineSessionSubsystemCancelMatchmaking *UOnlineSessionSubsystemCancelMatchmaking::CancelMatchmaking(
    UOnlineSessionSubsystem *Subsystem,
    const FUniqueNetIdRepl &SearchingPlayerId,
    FName SessionName)
{
    if (!IsValid(Subsystem))
    {
...
void UOnlineSessionSubsystemCancelMatchmaking::Activate()
{
    ...
    if (!(this->__Store__SearchingPlayerId.IsValid() && this->__Store__SearchingPlayerId.GetUniqueNetId().IsValid()))
    {
    ...
    this->DelegateHandle_OnCancelMatchmakingComplete =
        Handle->AddOnCancelMatchmakingCompleteDelegate_Handle(FOnCancelMatchmakingCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemCancelMatchmaking::HandleCallback_OnCancelMatchmakingComplete));

    if (!Handle->CancelMatchmaking(
            this->__Store__SearchingPlayerId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__SessionName))
    {
...
void UOnlineSessionSubsystemCancelMatchmaking::HandleCallback_OnCancelMatchmakingComplete(
    FName SessionName,
    bool bWasSuccessful)
{
    if (!IsValid(this->__Store__Subsystem))
...
UOnlineSessionSubsystemFindSessions *UOnlineSessionSubsystemFindSessions::FindSessions(
    UOnlineSessionSubsystem *Subsystem,
    const FUniqueNetIdRepl &SearchingPlayerId,
    UOnlineSessionSearch *SearchSettings)
{
...
void UOnlineSessionSubsystemFindSessions::Activate()
{
    ...
    this->DelegateHandle_OnFindSessionsComplete =
        Handle->AddOnFindSessionsCompleteDelegate_Handle(FOnFindSessionsCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemFindSessions::HandleCallback_OnFindSessionsComplete));

    if (!Handle->FindSessions(
            this->__Store__SearchingPlayerId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__SearchSettings->ToNative()))
    {
...
UOnlineSessionSubsystemFindSessionById *UOnlineSessionSubsystemFindSessionById::FindSessionById(
    UOnlineSessionSubsystem *Subsystem,
    const FUniqueNetIdRepl &SearchingUserId,
...
void UOnlineSessionSubsystemFindSessionById::Activate()
{
    ...
    if (!(this->__Store__SearchingUserId.IsValid() && this->__Store__SearchingUserId.GetUniqueNetId().IsValid()))
    {
        UE_LOG(LogOnlineBlueprint, Error, TEXT("Parameter 'SearchingUserId' was not valid"));
        this->OnCallFailed.Broadcast(0, false, FOnlineSessionSearchResultBP());
        return;
    }
    if (!(this->__Store__SessionId.IsValid() && this->__Store__SessionId.GetUniqueNetId().IsValid()))
    {
        UE_LOG(LogOnlineBlueprint, Error, TEXT("Parameter 'SessionId' was not valid"));
        this->OnCallFailed.Broadcast(0, false, FOnlineSessionSearchResultBP());
        return;
    }
    if (!(this->__Store__FriendId.IsValid() && this->__Store__FriendId.GetUniqueNetId().IsValid()))
    {
    ...
    auto __DelegateHandle_OnSingleSessionResultComplete = FOnSingleSessionResultComplete::FDelegate::CreateUObject(
        this,
        &UOnlineSessionSubsystemFindSessionById::HandleCallback_OnSingleSessionResultComplete);

    if (!Handle->FindSessionById(
            this->__Store__SearchingUserId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__SessionId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__FriendId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__UserData,
            __DelegateHandle_OnSingleSessionResultComplete))
    {
...
void UOnlineSessionSubsystemFindSessionById::HandleCallback_OnSingleSessionResultComplete(
    int32 LocalUserNum,
    bool bWasSuccessful,
    const FOnlineSessionSearchResult &SearchResult)
{
    ...
    this->OnSingleSessionResultComplete.Broadcast(
        LocalUserNum,
        bWasSuccessful,
        FOnlineSessionSearchResultBP::FromNative(SearchResult));
}

UOnlineSessionSubsystemCancelFindSessions *UOnlineSessionSubsystemCancelFindSessions::CancelFindSessions(
    UOnlineSessionSubsystem *Subsystem)
{
    if (!IsValid(Subsystem))
    {
...
void UOnlineSessionSubsystemCancelFindSessions::Activate()
{
    ...
    this->DelegateHandle_OnCancelFindSessionsComplete =
        Handle->AddOnCancelFindSessionsCompleteDelegate_Handle(FOnCancelFindSessionsCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemCancelFindSessions::HandleCallback_OnCancelFindSessionsComplete));
...
UOnlineSessionSubsystemPingSearchResults *UOnlineSessionSubsystemPingSearchResults::PingSearchResults(
    UOnlineSessionSubsystem *Subsystem,
...
void UOnlineSessionSubsystemPingSearchResults::Activate()
{
    ...
    this->DelegateHandle_OnPingSearchResultsComplete =
        Handle->AddOnPingSearchResultsCompleteDelegate_Handle(FOnPingSearchResultsCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemPingSearchResults::HandleCallback_OnPingSearchResultsComplete));
...
UOnlineSessionSubsystemJoinSession *UOnlineSessionSubsystemJoinSession::JoinSession(
    UOnlineSessionSubsystem *Subsystem,
    const FUniqueNetIdRepl &LocalUserId,
    FName SessionName,
    const FOnlineSessionSearchResultBP &DesiredSession)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
...
void UOnlineSessionSubsystemJoinSession::Activate()
{
    ...
    this->DelegateHandle_OnJoinSessionComplete =
        Handle->AddOnJoinSessionCompleteDelegate_Handle(FOnJoinSessionCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemJoinSession::HandleCallback_OnJoinSessionComplete));

    if (!Handle->JoinSession(
            this->__Store__LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__SessionName,
            this->__Store__DesiredSession.ToNative()))
    {
...
void UOnlineSessionSubsystemJoinSession::HandleCallback_OnJoinSessionComplete(
    FName SessionName,
...
UOnlineSessionSubsystemFindFriendSession *UOnlineSessionSubsystemFindFriendSession::FindFriendSession(
    UOnlineSessionSubsystem *Subsystem,
    int32 LocalUserNum,
    const FUniqueNetIdRepl &Friend)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
...
void UOnlineSessionSubsystemFindFriendSession::Activate()
{
    ...
    if (!(this->__Store__Friend.IsValid() && this->__Store__Friend.GetUniqueNetId().IsValid()))
    {
    ...
    this->DelegateHandle_OnFindFriendSessionComplete = Handle->AddOnFindFriendSessionCompleteDelegate_Handle(
        this->__Store__LocalUserNum,
        FOnFindFriendSessionCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemFindFriendSession::HandleCallback_OnFindFriendSessionComplete));

    if (!Handle->FindFriendSession(
            this->__Store__LocalUserNum,
            this->__Store__Friend.GetUniqueNetId().ToSharedRef().Get()))
    {
        UE_LOG(LogOnlineBlueprint, Error, TEXT("Call 'FindFriendSession' did not start successfully"));
        Handle->ClearOnFindFriendSessionCompleteDelegate_Handle(
            this->__Store__LocalUserNum,
            this->DelegateHandle_OnFindFriendSessionComplete);
        this->OnCallFailed.Broadcast(false, TArray<FOnlineSessionSearchResultBP>());
        return;
    }
}

void UOnlineSessionSubsystemFindFriendSession::HandleCallback_OnFindFriendSessionComplete(
...
bool UOnlineSessionSubsystem::SendSessionInviteToFriend(
    const FUniqueNetIdRepl &LocalUserId,
    FName SessionName,
    const FUniqueNetIdRepl &Friend)
{
    ...
    if (!(Friend.IsValid() && Friend.GetUniqueNetId().IsValid()))
    {
        return false;
    }

    auto __Result = Handle->SendSessionInviteToFriend(
        LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
        SessionName,
        Friend.GetUniqueNetId().ToSharedRef().Get());

    return __Result;
}

bool UOnlineSessionSubsystem::SendSessionInviteToFriends(
    const FUniqueNetIdRepl &LocalUserId,
    FName SessionName,
    const TArray<FUniqueNetIdRepl> &Friends)
{
    check(!this->HasAnyFlags(RF_ClassDefaultObject));
    auto Handle = this->GetHandle();
    if (!this->IsHandleValid(Handle))
    ...
    if (!(ValidateArrayElements<FUniqueNetIdRepl>(Friends, [](const FUniqueNetIdRepl &Val) {
            return Val.IsValid() && Val.GetUniqueNetId().IsValid();
        })))
    {
        return false;
    ...
    auto __Result = Handle->SendSessionInviteToFriends(
        LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
        SessionName,
        ConvertArrayElements<FUniqueNetIdRepl, FUniqueNetIdRef>(Friends, [](const FUniqueNetIdRepl &Val) {
            return Val.GetUniqueNetId().ToSharedRef();
        }));
...
FString UOnlineSessionSubsystem::GetVoiceChatRoomName(int32 LocalUserNum, FName SessionName)
{
    check(!this->HasAnyFlags(RF_ClassDefaultObject));
    auto Handle = this->GetHandle();
    if (!this->IsHandleValid(Handle))
    ...
    auto __Result = Handle->GetVoiceChatRoomName(LocalUserNum, SessionName);

    return __Result;
}

UOnlineSessionSubsystemRegisterPlayers *UOnlineSessionSubsystemRegisterPlayers::RegisterPlayers(
    UOnlineSessionSubsystem *Subsystem,
    FName SessionName,
    const TArray<FUniqueNetIdRepl> &Players,
    bool bWasInvited)
{
    if (!IsValid(Subsystem))
    {
...
void UOnlineSessionSubsystemRegisterPlayers::Activate()
{
    ...
    if (!(ValidateArrayElements<FUniqueNetIdRepl>(this->__Store__Players, [](const FUniqueNetIdRepl &Val) {
            return Val.IsValid() && Val.GetUniqueNetId().IsValid();
        })))
    {
    ...
    this->DelegateHandle_OnRegisterPlayersComplete =
        Handle->AddOnRegisterPlayersCompleteDelegate_Handle(FOnRegisterPlayersCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemRegisterPlayers::HandleCallback_OnRegisterPlayersComplete));

    if (!Handle->RegisterPlayers(
            this->__Store__SessionName,
            ConvertArrayElements<FUniqueNetIdRepl, FUniqueNetIdRef>(
                this->__Store__Players,
                [](const FUniqueNetIdRepl &Val) {
                    return Val.GetUniqueNetId().ToSharedRef();
                }),
            this->__Store__bWasInvited))
    {
...
void UOnlineSessionSubsystemRegisterPlayers::HandleCallback_OnRegisterPlayersComplete(
    FName SessionName,
...
UOnlineSessionSubsystemUnregisterPlayers *UOnlineSessionSubsystemUnregisterPlayers::UnregisterPlayers(
    UOnlineSessionSubsystem *Subsystem,
    FName SessionName,
    const TArray<FUniqueNetIdRepl> &Players)
{
...
void UOnlineSessionSubsystemUnregisterPlayers::Activate()
{
    ...
    this->DelegateHandle_OnUnregisterPlayersComplete =
        Handle->AddOnUnregisterPlayersCompleteDelegate_Handle(FOnUnregisterPlayersCompleteDelegate::CreateUObject(
            this,
            &UOnlineSessionSubsystemUnregisterPlayers::HandleCallback_OnUnregisterPlayersComplete));

    if (!Handle->UnregisterPlayers(
            this->__Store__SessionName,
            ConvertArrayElements<FUniqueNetIdRepl, FUniqueNetIdRef>(
                this->__Store__Players,
                [](const FUniqueNetIdRepl &Val) {
...
void UOnlineSessionSubsystemUnregisterPlayers::HandleCallback_OnUnregisterPlayersComplete(
    FName SessionName,
    const TArray<FUniqueNetIdRef> &PlayerIds,
    bool bWasSuccessful)
{
...
UOnlineSessionSubsystemRegisterLocalPlayer *UOnlineSessionSubsystemRegisterLocalPlayer::RegisterLocalPlayer(
    UOnlineSessionSubsystem *Subsystem,
...
void UOnlineSessionSubsystemRegisterLocalPlayer::Activate()
{
    ...
    if (!(this->__Store__PlayerId.IsValid() && this->__Store__PlayerId.GetUniqueNetId().IsValid()))
    {
    ...
    auto __DelegateHandle_OnRegisterLocalPlayerComplete = FOnRegisterLocalPlayerCompleteDelegate::CreateUObject(
        this,
        &UOnlineSessionSubsystemRegisterLocalPlayer::HandleCallback_OnRegisterLocalPlayerComplete);

    Handle->RegisterLocalPlayer(
        this->__Store__PlayerId.GetUniqueNetId().ToSharedRef().Get(),
        this->__Store__SessionName,
        __DelegateHandle_OnRegisterLocalPlayerComplete);
}

void UOnlineSessionSubsystemRegisterLocalPlayer::HandleCallback_OnRegisterLocalPlayerComplete(
    const FUniqueNetId &Param1,
    EOnJoinSessionCompleteResult::Type Param2)
{
    if (!IsValid(this->__Store__Subsystem))
    {
        UE_LOG(LogOnlineBlueprint, Error, TEXT("Subsystem was not valid during callback handling"));
    ...
    this->OnRegisterLocalPlayerComplete.Broadcast(
        ConvertDangerousUniqueNetIdToRepl(Param1),
        (EOnJoinSessionCompleteResult_)(Param2));
}

UOnlineSessionSubsystemUnregisterLocalPlayer *UOnlineSessionSubsystemUnregisterLocalPlayer::UnregisterLocalPlayer(
    UOnlineSessionSubsystem *Subsystem,
    const FUniqueNetIdRepl &PlayerId,
    FName SessionName)
{
...
void UOnlineSessionSubsystemUnregisterLocalPlayer::Activate()
{
    ...
    auto __DelegateHandle_OnUnregisterLocalPlayerComplete = FOnUnregisterLocalPlayerCompleteDelegate::CreateUObject(
        this,
        &UOnlineSessionSubsystemUnregisterLocalPlayer::HandleCallback_OnUnregisterLocalPlayerComplete);

    Handle->UnregisterLocalPlayer(
        this->__Store__PlayerId.GetUniqueNetId().ToSharedRef().Get(),
        this->__Store__SessionName,
        __DelegateHandle_OnUnregisterLocalPlayerComplete);
}

void UOnlineSessionSubsystemUnregisterLocalPlayer::HandleCallback_OnUnregisterLocalPlayerComplete(
    const FUniqueNetId &Param1,
    const bool Param2)
{
    if (!IsValid(this->__Store__Subsystem))
...
void UOnlineSessionSubsystem::RemovePlayerFromSession(
    int32 LocalUserNum,
    FName SessionName,
    const FUniqueNetIdRepl &TargetPlayerId)
{
    ...
    if (!(TargetPlayerId.IsValid() && TargetPlayerId.GetUniqueNetId().IsValid()))
    {
        return;
    }
