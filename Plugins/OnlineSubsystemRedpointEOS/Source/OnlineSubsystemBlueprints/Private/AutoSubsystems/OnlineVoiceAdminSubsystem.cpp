...
FName UOnlineVoiceAdminSubsystem::OSSNameToAssignDuringConstruction = NAME_Default;
...
UOnlineVoiceAdminSubsystem::UOnlineVoiceAdminSubsystem()
{
    ...
    this->OSSName = UOnlineVoiceAdminSubsystem::OSSNameToAssignDuringConstruction;
    ...
    UE_LOG(
        LogOnlineBlueprint,
        Verbose,
        TEXT("OnlineVoiceAdminSubsystem subsystem initialized in context %s"),
...
UOnlineVoiceAdminSubsystemCreateChannelCredentials *UOnlineVoiceAdminSubsystemCreateChannelCredentials::
    CreateChannelCredentials(
        ...
        const TArray<FUniqueNetIdRepl> &TargetUserIds)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
            LogOnlineBlueprint,
            Error,
            TEXT("OnlineVoiceAdminSubsystem is not available. It's possible the online subsystem you are using doesn't "
    ...
    UOnlineVoiceAdminSubsystemCreateChannelCredentials *Node =
        NewObject<UOnlineVoiceAdminSubsystemCreateChannelCredentials>();
...
void UOnlineVoiceAdminSubsystemCreateChannelCredentials::Activate()
{
    ...
    if (!(ValidateArrayElements<FUniqueNetIdRepl>(this->__Store__TargetUserIds, [](const FUniqueNetIdRepl &Val) {
    ...
    if (this->__Store__CallUniquenessId != TEXT(""))
    {
        if (this->__Store__Subsystem->__InFlightRequests.Contains(this->__Store__CallUniquenessId))
        {
            ...
            this->OnCallFailed.Broadcast(
                FOnlineErrorInfo(),
                FUniqueNetIdRepl(),
                TArray<FVoiceAdminChannelCredentialsBP>());
            return;
        }
    ...
    auto __DelegateHandle_OnVoiceAdminCreateChannelCredentialsComplete =
        FOnVoiceAdminCreateChannelCredentialsComplete::CreateUObject(
            this,
            &UOnlineVoiceAdminSubsystemCreateChannelCredentials::
                HandleCallback_OnVoiceAdminCreateChannelCredentialsComplete);

    if (!Handle->CreateChannelCredentials(
            this->__Store__LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__ChannelName,
            ConvertArrayElements<FUniqueNetIdRepl, TSharedRef<const FUniqueNetId>>(
                this->__Store__TargetUserIds,
                [](const FUniqueNetIdRepl &Val) {
                    return Val.GetUniqueNetId().ToSharedRef();
                }),
            __DelegateHandle_OnVoiceAdminCreateChannelCredentialsComplete))
    {
...
void UOnlineVoiceAdminSubsystemCreateChannelCredentials::HandleCallback_OnVoiceAdminCreateChannelCredentialsComplete(
    ...
    const TArray<FVoiceAdminChannelCredentials> &Credentials)
{
    ...
    this->OnVoiceAdminCreateChannelCredentialsComplete.Broadcast(
        FOnlineErrorInfo::FromNative(Result),
        ConvertDangerousUniqueNetIdToRepl(LocalUserId),
        ConvertArrayElements<FVoiceAdminChannelCredentials, FVoiceAdminChannelCredentialsBP>(
            Credentials,
            [](const FVoiceAdminChannelCredentials &Val) {
                return FVoiceAdminChannelCredentialsBP::FromNative(Val);
            }));
}

UOnlineVoiceAdminSubsystemKickParticipant *UOnlineVoiceAdminSubsystemKickParticipant::KickParticipant(
    UOnlineVoiceAdminSubsystem *Subsystem,
    const FUniqueNetIdRepl &LocalUserId,
    const FString &ChannelName,
...
void UOnlineVoiceAdminSubsystemKickParticipant::Activate()
{
    ...
    auto __DelegateHandle_OnVoiceAdminKickParticipantComplete = FOnVoiceAdminKickParticipantComplete::CreateUObject(
        this,
        &UOnlineVoiceAdminSubsystemKickParticipant::HandleCallback_OnVoiceAdminKickParticipantComplete);

    if (!Handle->KickParticipant(
            this->__Store__LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__ChannelName,
            this->__Store__TargetUserId.GetUniqueNetId().ToSharedRef().Get(),
            __DelegateHandle_OnVoiceAdminKickParticipantComplete))
    {
...
void UOnlineVoiceAdminSubsystemKickParticipant::HandleCallback_OnVoiceAdminKickParticipantComplete(
    const FOnlineError &Result,
    const FUniqueNetId &LocalUserId,
    const FUniqueNetId &TargetUserId)
{
    ...
    this->OnVoiceAdminKickParticipantComplete.Broadcast(
        FOnlineErrorInfo::FromNative(Result),
        ConvertDangerousUniqueNetIdToRepl(LocalUserId),
        ...
        bool bMuted)
{
    ...
    UOnlineVoiceAdminSubsystemSetParticipantHardMute *Node =
        NewObject<UOnlineVoiceAdminSubsystemSetParticipantHardMute>();
    Node->__Store__Subsystem = Subsystem;
    Node->__Store__CallUniquenessId = TEXT("");
    Node->__Store__LocalUserId = LocalUserId;
    Node->__Store__ChannelName = ChannelName;
...
void UOnlineVoiceAdminSubsystemSetParticipantHardMute::Activate()
{
    ...
    auto __DelegateHandle_OnVoiceAdminSetParticipantHardMuteComplete =
        FOnVoiceAdminSetParticipantHardMuteComplete::CreateUObject(
            this,
            &UOnlineVoiceAdminSubsystemSetParticipantHardMute::
                HandleCallback_OnVoiceAdminSetParticipantHardMuteComplete);

    if (!Handle->SetParticipantHardMute(
            this->__Store__LocalUserId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__ChannelName,
            this->__Store__TargetUserId.GetUniqueNetId().ToSharedRef().Get(),
            this->__Store__bMuted,
            __DelegateHandle_OnVoiceAdminSetParticipantHardMuteComplete))
    {
...
void UOnlineVoiceAdminSubsystemSetParticipantHardMute::HandleCallback_OnVoiceAdminSetParticipantHardMuteComplete(
    const FOnlineError &Result,
    const FUniqueNetId &LocalUserId,
    const FUniqueNetId &TargetUserId,
    bool bIsNowMuted)
{
    ...
    this->OnVoiceAdminSetParticipantHardMuteComplete.Broadcast(
        FOnlineErrorInfo::FromNative(Result),
        ConvertDangerousUniqueNetIdToRepl(LocalUserId),
        ConvertDangerousUniqueNetIdToRepl(TargetUserId),
        bIsNowMuted);
