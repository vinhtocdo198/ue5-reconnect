...
FName UOnlineLeaderboardsSubsystem::OSSNameToAssignDuringConstruction = NAME_Default;
...
bool UOnlineLeaderboardsSubsystem::IsHandleValid(
    const TSharedPtr<class IOnlineLeaderboards, ESPMode::ThreadSafe> &InHandle)
{
...
UOnlineLeaderboardsSubsystem::UOnlineLeaderboardsSubsystem()
{
    ...
    this->OSSName = UOnlineLeaderboardsSubsystem::OSSNameToAssignDuringConstruction;
    ...
    UE_LOG(
        LogOnlineBlueprint,
        Verbose,
        TEXT("OnlineLeaderboardsSubsystem subsystem initialized in context %s"),
    ...
    if (Handle.IsValid())
    {
        ...
        this->DelegateHandle_OnLeaderboardFlushComplete = Handle->AddOnLeaderboardFlushCompleteDelegate_Handle(
            FOnLeaderboardFlushComplete::FDelegate::CreateWeakLambda(
                this,
                [this](const FName &SessionName, bool bWasSuccessful) {
...
UOnlineLeaderboardsSubsystemReadLeaderboards *UOnlineLeaderboardsSubsystemReadLeaderboards::ReadLeaderboards(
    ...
    UOnlineLeaderboardRead *ReadObject)
{
    if (!IsValid(Subsystem))
    {
        UE_LOG(
            ...
            Error,
            TEXT(
                "OnlineLeaderboardsSubsystem is not available. It's possible the online subsystem you are using "
...
void UOnlineLeaderboardsSubsystemReadLeaderboards::Activate()
{
    ...
    this->DelegateHandle_OnLeaderboardReadComplete =
        Handle->AddOnLeaderboardReadCompleteDelegate_Handle(FOnLeaderboardReadCompleteDelegate::CreateUObject(
            this,
            &UOnlineLeaderboardsSubsystemReadLeaderboards::HandleCallback_OnLeaderboardReadComplete));

    if (!Handle->ReadLeaderboards(
            ...
            this->__Store__ReadObject->GetLeaderboard()))
    {
...
void UOnlineLeaderboardsSubsystemReadLeaderboards::HandleCallback_OnLeaderboardReadComplete(bool bWasSuccessful)
{
    ...
    if (CurrentTaskState == EOnlineAsyncTaskState::NotStarted || CurrentTaskState == EOnlineAsyncTaskState::InProgress)
    {
        ...
        UOnlineLeaderboardRead *ReadObject)
{
    ...
    UOnlineLeaderboardsSubsystemReadLeaderboardsForFriends *Node =
        NewObject<UOnlineLeaderboardsSubsystemReadLeaderboardsForFriends>();
    Node->__Store__Subsystem = Subsystem;
    Node->__Store__CallUniquenessId = TEXT("");
...
void UOnlineLeaderboardsSubsystemReadLeaderboardsForFriends::Activate()
{
    ...
    this->DelegateHandle_OnLeaderboardReadComplete =
        Handle->AddOnLeaderboardReadCompleteDelegate_Handle(FOnLeaderboardReadCompleteDelegate::CreateUObject(
            this,
            &UOnlineLeaderboardsSubsystemReadLeaderboardsForFriends::HandleCallback_OnLeaderboardReadComplete));
...
void UOnlineLeaderboardsSubsystemReadLeaderboardsForFriends::HandleCallback_OnLeaderboardReadComplete(
    bool bWasSuccessful)
{
    if (!IsValid(this->__Store__Subsystem))
    {
        ...
        UOnlineLeaderboardRead *ReadObject)
{
    ...
    UOnlineLeaderboardsSubsystemReadLeaderboardsAroundRank *Node =
        NewObject<UOnlineLeaderboardsSubsystemReadLeaderboardsAroundRank>();
    Node->__Store__Subsystem = Subsystem;
    Node->__Store__CallUniquenessId = TEXT("");
...
void UOnlineLeaderboardsSubsystemReadLeaderboardsAroundRank::Activate()
{
    ...
    this->DelegateHandle_OnLeaderboardReadComplete =
        Handle->AddOnLeaderboardReadCompleteDelegate_Handle(FOnLeaderboardReadCompleteDelegate::CreateUObject(
            this,
            &UOnlineLeaderboardsSubsystemReadLeaderboardsAroundRank::HandleCallback_OnLeaderboardReadComplete));

    if (!Handle->ReadLeaderboardsAroundRank(
            this->__Store__Rank,
            (uint32)(this->__Store__Range),
            this->__Store__ReadObject->GetLeaderboard()))
    {
...
void UOnlineLeaderboardsSubsystemReadLeaderboardsAroundRank::HandleCallback_OnLeaderboardReadComplete(
    bool bWasSuccessful)
{
    if (!IsValid(this->__Store__Subsystem))
    {
        ...
        UOnlineLeaderboardRead *ReadObject)
{
    ...
    UOnlineLeaderboardsSubsystemReadLeaderboardsAroundUser *Node =
        NewObject<UOnlineLeaderboardsSubsystemReadLeaderboardsAroundUser>();
    Node->__Store__Subsystem = Subsystem;
    Node->__Store__CallUniquenessId = TEXT("");
...
void UOnlineLeaderboardsSubsystemReadLeaderboardsAroundUser::Activate()
{
    ...
    if (!(this->__Store__Player.IsValid() && this->__Store__Player.GetUniqueNetId().IsValid()))
    {
    ...
    this->DelegateHandle_OnLeaderboardReadComplete =
        Handle->AddOnLeaderboardReadCompleteDelegate_Handle(FOnLeaderboardReadCompleteDelegate::CreateUObject(
            this,
            &UOnlineLeaderboardsSubsystemReadLeaderboardsAroundUser::HandleCallback_OnLeaderboardReadComplete));

    if (!Handle->ReadLeaderboardsAroundUser(
            this->__Store__Player.GetUniqueNetId().ToSharedRef(),
            (uint32)(this->__Store__Range),
            this->__Store__ReadObject->GetLeaderboard()))
    {
...
void UOnlineLeaderboardsSubsystemReadLeaderboardsAroundUser::HandleCallback_OnLeaderboardReadComplete(
    bool bWasSuccessful)
{
    if (!IsValid(this->__Store__Subsystem))
    {
...
bool UOnlineLeaderboardsSubsystem::WriteLeaderboards(
    FName SessionName,
    const FUniqueNetIdRepl &Player,
    UOnlineLeaderboardWrite *WriteObject)
{
    ...
    if (!(Player.IsValid() && Player.GetUniqueNetId().IsValid()))
    {
        return false;
    }
    ...
    auto __Result =
        Handle->WriteLeaderboards(SessionName, Player.GetUniqueNetId().ToSharedRef().Get(), *WriteObject->ToNative());
